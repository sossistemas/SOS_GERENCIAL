object frmrestore: Tfrmrestore
  ...
  Caption = 'BACKUP | Restaurar C'#243'pia de Seguran'#231'a'
  ClientHeight = 146
  ClientWidth = 419
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    object edestino: TJvDirectoryEdit
      Left = 59
      Top = 43
      Width = 318
      Height = 21
    ...
    object eorigem: TJvFilenameEdit
      Left = 59
      Top = 16
      Width = 317
      Height = 21
      Filter = 'C'#243'pia de Seguran'#231'a - ZIP|*.zip'
      NumGlyphs = 1
      TabOrder = 0
      OnKeyPress = eorigemKeyPress
    end
