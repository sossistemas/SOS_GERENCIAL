object frmproduto_pedido: Tfrmproduto_pedido
          ...
          object Panel2: TPanel
            ...
            object grid1: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'CODBARRA'#9'15'#9'C'#243'd.Barras'
                'produto'#9'43'#9'Produto'
                'QTDE'#9'10'#9'Quantidade'
                'UNITARIO'#9'9'#9'Unit'#225'rio'
                'TOTAL'#9'10'#9'Total'
                'RECEBIDO'#9'9'#9'Recebido'
                'FALTA'#9'10'#9'Falta')
  ...
  object qrpedido_item: TZQuery
    ...
    OnNewRecord = qrpedido_itemNewRecord
    SQL.Strings = (
      'select * from c000038')
    Params = <>
    Left = 516
    ...
    object qrpedido_itemATB: TWideStringField
      FieldName = 'ATB'
      Required = True
      Visible = False
      Size = 30
  ...
  object qrnf: TZQuery
    ...
    object qrnfOBSERVACAO: TBlobField
      FieldName = 'OBSERVACAO'
    end
    object qrnfATB: TWideStringField
      FieldName = 'ATB'
      Required = True
      Size = 30
    end
  ...
  object fxpedido: TfrxReport
    ...
    ReportOptions.LastChange = 43626.718266354170000000
    ...
    Datasets = <
      ...
      item
        DataSet = fspedido_fornecedor
        DataSetName = 'fspedido_fornecedor'
      end
      item
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo30: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fspedido_fornecedor."COMPLEMENTO"]')
          ParentFont = False
        end
        ...
        object Memo32: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[fspedido_fornecedor."TELEFONE1"]  [fspedido_fornecedor."TELEFON' +
              'E2"]  [fspedido_fornecedor."FAX"]')
          ParentFont = False
        end
      ...
      object MasterData3: TfrxMasterData
        ...
        object Memo49: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fspedido_item."CODBARRA"]')
          ParentFont = False
        end
      end
      object Footer1: TfrxFooter
        FillType = ftBrush
        Height = 110.385900000000000000
