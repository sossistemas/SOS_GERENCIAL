object frmxloc_subgrupo: Tfrmxloc_subgrupo
  Left = 113
  Top = 256
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'SUBGRUPO | Localizar'
  ClientHeight = 353
  ClientWidth = 708
  Color = clBtnFace
  ...
  object GRID: TwwDBGrid
    ...
    Selected.Strings = (
      ...
      'CODGRUPO'#9'9'#9'CD.GRUPO'
      'SUBGRUPO'#9'49'#9'SUBGRUPO'
      'GRUPO'#9'30'#9'GRUPO')
  ...
  object query: TZQuery
    ...
    object querySUBGRUPO: TWideStringField
      FieldName = 'SUBGRUPO'
      Size = 30
    end
    object queryALTERA_PRECO_ABCFARMA: TWideStringField
