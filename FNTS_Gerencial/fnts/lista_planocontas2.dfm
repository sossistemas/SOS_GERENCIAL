object frmlista_planocontas2: Tfrmlista_planocontas2
  ...
  object fxplanocontas: TfrxReport
    ...
    ReportOptions.LastChange = 41289.669874016200000000
    ...
    object Page1: TfrxReportPage
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object Memo17: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            'suporte@icloudinformatica.com.br')
          ParentFont = False
        end
      end
      ...
      object DetailData1: TfrxDetailData
        ...
        object Memo1: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fsconta."CLASSIFICACAO"] - [fsconta."CONTA"]')
          ParentFont = False
        end
  ...
  object qrnivel1: TZQuery
    Connection = frmmodulo.Conexao
    SQL.Strings = (
      'select * from c000035 where nivel = 1')
    Params = <>
    Left = 488
    Top = 336
    object qrnivel1CODIGO: TWideStringField
      FieldName = 'CODIGO'
      Required = True
      Size = 6
    end
    object qrnivel1CONTA: TWideStringField
      FieldName = 'CONTA'
      Size = 40
    end
    object qrnivel1TIPO: TIntegerField
      FieldName = 'TIPO'
    end
    object qrnivel1ENTRADA: TFloatField
      FieldName = 'ENTRADA'
    end
    object qrnivel1SAIDA: TFloatField
      FieldName = 'SAIDA'
    end
    object qrnivel1SALDO: TFloatField
      FieldName = 'SALDO'
    end
    object qrnivel1FILTRO: TIntegerField
      FieldName = 'FILTRO'
    end
    object qrnivel1CLASSIFICACAO: TWideStringField
      FieldName = 'CLASSIFICACAO'
      Size = 10
    end
    object qrnivel1CODGRUPO: TWideStringField
      FieldName = 'CODGRUPO'
      Size = 6
    end
    object qrnivel1NIVEL: TIntegerField
      FieldName = 'NIVEL'
    end
  end
  object qrconta: TZQuery
    ...
    SortedFields = 'TIPO'
    SQL.Strings = (
      'select * from c000035 where nivel = 3')
    Params = <>
    MasterFields = 'TIPO'
    MasterSource = dsnivel1
    IndexFieldNames = 'TIPO Asc'
    Left = 144
    Top = 288
    object qrcontaCODIGO: TWideStringField
      FieldName = 'CODIGO'
      Required = True
      Size = 6
    end
    object qrcontaCONTA: TWideStringField
      FieldName = 'CONTA'
      Size = 40
    end
    object qrcontaTIPO: TIntegerField
      FieldName = 'TIPO'
    end
    object qrcontaENTRADA: TFloatField
      FieldName = 'ENTRADA'
    end
    object qrcontaSAIDA: TFloatField
      FieldName = 'SAIDA'
    end
    object qrcontaSALDO: TFloatField
      FieldName = 'SALDO'
    end
    object qrcontaFILTRO: TIntegerField
      FieldName = 'FILTRO'
    end
    object qrcontaCLASSIFICACAO: TWideStringField
      FieldName = 'CLASSIFICACAO'
      Size = 10
    end
    object qrcontaCODGRUPO: TWideStringField
      FieldName = 'CODGRUPO'
      Size = 6
    end
    object qrcontaNIVEL: TIntegerField
      FieldName = 'NIVEL'
    end
  end
