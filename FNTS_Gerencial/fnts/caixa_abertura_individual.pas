...
uses
  ...
  ExtCtrls, Buttons, Menus, DB,
  ZDataset, AdvGlowButton, AdvMetroButton,
  AdvSmoothExpanderPanel, JvToolEdit, JvExMask, JvBaseEdits, ZAbstractRODataset,
...
procedure Tfrmcaixa_abertura_individual.bfecharClick(Sender: TObject);
begin
  close;
end;
