...
uses
  ...
  ZAbstractRODataset, ZAbstractDataset, ZDataset, Vcl.Menus, AdvGlowButton, Vcl.ExtCtrls,
  Vcl.Grids, Wwdbigrd, Wwdbgrid;
...
procedure TfrmOrcamento_serial.wwDBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
