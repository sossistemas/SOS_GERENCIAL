...
uses
  ...
  Dialogs, ExtCtrls, DBCtrls, StdCtrls, Buttons, TFlatPanelUnit, Menus, DB,
  ZAbstractRODataset, ZDataset, Grids, DBGrids, AdvGlowButton, Wwdbigrd,
  Wwdbgrid, UCBase, AdvMetroButton, AdvSmoothExpanderPanel, ZAbstractDataset,
  AdvSmoothPanel;
...
begin
  ...
  qrsetor.fieldbyname('setor').asstring := ansiuppercase(qrsetor.fieldbyname('setor').asstring);
