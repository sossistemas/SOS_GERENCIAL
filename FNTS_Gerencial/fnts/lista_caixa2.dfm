object frmlista_caixa2: Tfrmlista_caixa2
  Left = 286
  Top = 239
  BorderIcons = []
  BorderStyle = bsNone
  ...
  object fxcaixa: TfrxReport
    ...
    ReportOptions.LastChange = 45113.685905752320000000
  ...
  object fscaixa: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'CARTAO_NOME_CONSUMIDOR=CARTAO_NOME_CONSUMIDOR'
      'CARTAO_BIN=CARTAO_BIN'
      'CARTAO_VALIDADE=CARTAO_VALIDADE'
      'CARTAO_PARCELAS=CARTAO_PARCELAS'
      'CARTAO_4DIGITOS=CARTAO_4DIGITOS'
      'CARTAO_N_AUTORIZACAO=CARTAO_N_AUTORIZACAO'
      'CARTAO_NSU=CARTAO_NSU'
      'CARTAO_INSTITUICAO=CARTAO_INSTITUICAO'
      'CARTAO_ID_PAGAMENTO=CARTAO_ID_PAGAMENTO'
      'CHAVE=CHAVE'
      'NUMERO_CFE=NUMERO_CFE'
      'CARTAO_BANDEIRA=CARTAO_BANDEIRA'
      'CARTAO_RF=CARTAO_RF'
      'CARTAO_MENSAGEM=CARTAO_MENSAGEM'
      'HORA=HORA')
    DataSet = qrcaixa
    BCDToCurrency = False
    Left = 211
  ...
  object qrcaixa: TZQuery
    ...
    object qrcaixaCODIGO: TWideStringField
      FieldName = 'CODIGO'
      Required = True
      Size = 10
    end
    object qrcaixaCODCAIXA: TWideStringField
      FieldName = 'CODCAIXA'
      Size = 6
    end
    object qrcaixaCODOPERADOR: TWideStringField
    ...
    object qrcaixaSAIDA: TFloatField
      FieldName = 'SAIDA'
    end
    object qrcaixaENTRADA: TFloatField
      FieldName = 'ENTRADA'
    end
    object qrcaixaCODCONTA: TWideStringField
      FieldName = 'CODCONTA'
      Size = 6
    end
    object qrcaixaHISTORICO: TWideStringField
      FieldName = 'HISTORICO'
      Size = 60
    end
    object qrcaixaMOVIMENTO: TIntegerField
      FieldName = 'MOVIMENTO'
    end
    object qrcaixaVALOR: TFloatField
      FieldName = 'VALOR'
    end
    object qrcaixaCODNFSAIDA: TWideStringField
      FieldName = 'CODNFSAIDA'
      Size = 10
    end
    object qrcaixaCODVENDA: TWideStringField
      FieldName = 'CODVENDA'
    end
    object qrcaixaSERIAL_POS: TWideStringField
      FieldName = 'SERIAL_POS'
      Size = 100
    end
    object qrcaixaCARTAO_NOME_CONSUMIDOR: TWideStringField
      FieldName = 'CARTAO_NOME_CONSUMIDOR'
      Size = 200
    end
    object qrcaixaCARTAO_BIN: TWideStringField
      FieldName = 'CARTAO_BIN'
      Size = 30
    end
    object qrcaixaCARTAO_VALIDADE: TWideStringField
      FieldName = 'CARTAO_VALIDADE'
      Size = 10
    end
    object qrcaixaCARTAO_PARCELAS: TIntegerField
      FieldName = 'CARTAO_PARCELAS'
    end
    object qrcaixaCARTAO_4DIGITOS: TIntegerField
      FieldName = 'CARTAO_4DIGITOS'
    end
    object qrcaixaCARTAO_N_AUTORIZACAO: TWideStringField
      FieldName = 'CARTAO_N_AUTORIZACAO'
    end
    object qrcaixaCARTAO_NSU: TWideStringField
      FieldName = 'CARTAO_NSU'
      Size = 30
    end
    object qrcaixaCARTAO_INSTITUICAO: TWideStringField
      FieldName = 'CARTAO_INSTITUICAO'
      Size = 50
    end
    object qrcaixaCARTAO_ID_PAGAMENTO: TWideStringField
      FieldName = 'CARTAO_ID_PAGAMENTO'
    end
    object qrcaixaCHAVE: TWideStringField
      FieldName = 'CHAVE'
      Size = 100
    end
    object qrcaixaNUMERO_CFE: TWideStringField
      FieldName = 'NUMERO_CFE'
    end
    object qrcaixaCARTAO_BANDEIRA: TWideStringField
      FieldName = 'CARTAO_BANDEIRA'
      Size = 100
    end
    object qrcaixaCARTAO_RF: TWideStringField
      FieldName = 'CARTAO_RF'
    end
    object qrcaixaCARTAO_MENSAGEM: TWideStringField
      FieldName = 'CARTAO_MENSAGEM'
      Size = 200
    end
    object qrcaixaHORA: TWideStringField
      FieldName = 'HORA'
      Size = 8
    end
  end
