...
uses
  ...
  Mask, maskutils, AdvGlowButton, cxGraphics, cxControls, cxLookAndFeels,
  ...
  dxSkinValentine, dxSkinXmas2008Blue, cxCheckBox, dxSkinBlueprint,
  dxSkinDevExpressDarkStyle, dxSkinDevExpressStyle, dxSkinHighContrast,
  dxSkinSevenClassic, dxSkinSharpPlus, dxSkinTheAsphaltWorld, dxSkinVS2010,
  dxSkinWhiteprint, UCBase, dxGDIPlusClasses, AdvMetroButton,
...
uses
  modulo, principal, loc_grupo_servico,
...
begin
  ...
  frmmodulo.qrgrupo_servico.sql.add('select * from c000012 where atb like :atb order by grupo');
  ...
  frmmodulo.qrservico.sql.add('select * from c000011 where atb like :atb order by codigo');
...
begin
  ...
  begin
    Application.messagebox('Favor informar o nome do Serviço!', 'Atenção', mb_ok + mb_iconerror);
    DBEdit2.setfocus;
    exit;
  end;
  ...
  begin
    Application.messagebox('Favor informar o Grupo do Serviço!', 'Atenção', mb_ok + mb_iconerror);
    DBEdit28.setfocus;
    exit;
  end;
...
begin
  ...
  begin
    ...
    if DBEdit28.Text <> '000000' then
      if not frmprincipal.Locregistro(frmmodulo.qrgrupo_servico, DBEdit28.Text, 'codigo') then
...
begin
  ...
  begin
    Application.messagebox('Favor informar o valor do Serviço!', 'Atenção', mb_ok + mb_iconerror);
    ERENDA.setfocus;
    exit;
  end;
end;
