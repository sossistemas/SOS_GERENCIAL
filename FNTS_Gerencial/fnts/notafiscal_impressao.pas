...
uses
  ...
  Menus, DB, ZAbstractRODataset, ZDataset, frxDesgn, frxClass,
  frxDBSet, AdvGlowButton, AdvShapeButton, AdvReflectionImage, ZAbstractDataset;
...
uses
  modulo, principal, notafiscal, notafiscal_menu;

{$R *.dfm}

procedure Tfrmnotafiscal_impressao.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := cafree;
end;
...
05 - Bobina
  ...
  case combo_modelo.ItemIndex of
    0:
      TPa4logoClick(frmnotafiscal_impressao);
    1:
      TPrazaoClick(frmnotafiscal_impressao);
    2:
      Personalizado1click(frmnotafiscal_impressao);
  end;
...
procedure Tfrmnotafiscal_impressao.combo_modeloKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    bgravar.SetFocus;
end;
...
begin
  ...
  fxnotafiscal.LoadFromFile('\SOS\server\rel\f000061.fr3');
...
begin
  ...
  writeln(arquivo, '');
  writeln(arquivo, '');
  writeln(arquivo, frmprincipal.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('CIDADE').asstring, 50, ' ', 'D') + ' ' + frmprincipal.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('TELEFONE1').asstring + '  ' + frmmodulo.qrCLIENTE.fieldbyname('TELEFONE2').asstring, 27, ' ', 'D') + ' ' + frmprincipal.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('UF').asstring, 6, ' ', 'D') + ' ' + frmprincipal.Texto_Justifica(frmmodulo.qrCLIENTE.fieldbyname('RG').asstring, 38, ' ', 'D') + ' ' + frmprincipal.Texto_Justifica(timetostr(time), 10, ' ', 'D'));
  writeln(arquivo, '');
  writeln(arquivo, '');
  writeln(arquivo, '');
  writeln(arquivo, '');
  ...
  if frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_VALOR1').asfloat <> 0 then
    texto1 := formatfloat('###,###,##0.00', frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_VALOR1').asfloat);
  if frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_VALOR2').asfloat <> 0 then
    texto2 := formatfloat('###,###,##0.00', frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_VALOR2').asfloat);
  writeln(arquivo, frmprincipal.Texto_Justifica(frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_NUMERO1').asstring, 31, ' ', 'D') + ' ' + frmprincipal.Texto_Justifica(texto1, 15, ' ', 'E') + '     ' + frmprincipal.Texto_Justifica(frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_DATA1').asstring, 17, ' ', 'D') + ' ' + frmprincipal.Texto_Justifica(frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_NUMERO2').asstring, 31, ' ', 'D') + ' ' + frmprincipal.Texto_Justifica(texto2, 16, ' ', 'E') + '     ' + frmprincipal.Texto_Justifica(frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_DATA2').asstring, 10, ' ', 'D'));
  writeln(arquivo, '');
  ...
  if frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_VALOR4').asfloat <> 0 then
    ...
    texto2 := '';
  writeln(arquivo, frmprincipal.Texto_Justifica(frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_NUMERO3').asstring, 31, ' ', 'D') + ' ' + frmprincipal.Texto_Justifica(texto1, 15, ' ', 'E') + '     ' + frmprincipal.Texto_Justifica(frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_DATA3').asstring, 17, ' ', 'D') + ' ' + frmprincipal.Texto_Justifica(frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_NUMERO4').asstring, 31, ' ', 'D') + ' ' + frmprincipal.Texto_Justifica(texto2, 16, ' ', 'E') + '     ' + frmprincipal.Texto_Justifica(frmnotafiscal_menu.qrnota.fieldbyname('FATURAMENTO_DATA4').asstring, 10, ' ', 'D'));
  writeln(arquivo, '');
  writeln(arquivo, '');
  ...
  if frmnotafiscal_menu.qrnota.fieldbyname('BASE_CALCULO').asfloat <> 0 then
    texto1 := FORMATFLOAT('###,###,##0.00', frmnotafiscal_menu.qrnota.fieldbyname('BASE_CALCULO').asfloat)
  else
    texto1 := '';
  if frmnotafiscal_menu.qrnota.fieldbyname('VALOR_ICMS').asfloat <> 0 then
    texto2 := FORMATFLOAT('###,###,##0.00', frmnotafiscal_menu.qrnota.fieldbyname('VALOR_ICMS').asfloat)
  else
    texto2 := '';
  if frmnotafiscal_menu.qrnota.fieldbyname('BASE_SUB').asfloat <> 0 then
    texto3 := FORMATFLOAT('###,###,##0.00', frmnotafiscal_menu.qrnota.fieldbyname('BASE_SUB').asfloat)
  else
    texto3 := '';
  if frmnotafiscal_menu.qrnota.fieldbyname('ICMS_SUB').asfloat <> 0 then
    texto4 := FORMATFLOAT('###,###,##0.00', frmnotafiscal_menu.qrnota.fieldbyname('ICMS_SUB').asfloat)
  else
    texto4 := '';
  if frmnotafiscal_menu.qrnota.fieldbyname('VALOR_PRODUTOS').asfloat <> 0 then
    texto5 := FORMATFLOAT('###,###,##0.00', frmnotafiscal_menu.qrnota.fieldbyname('VALOR_PRODUTOS').asfloat)
  else
    texto5 := '';
  ...
  writeln(arquivo, '');
  writeln(arquivo, '');
  if frmnotafiscal_menu.qrnota.fieldbyname('FRETE').asfloat <> 0 then
    texto1 := FORMATFLOAT('###,###,##0.00', frmnotafiscal_menu.qrnota.fieldbyname('FRETE').asfloat)
  else
    texto1 := '';
  if frmnotafiscal_menu.qrnota.fieldbyname('SEGURO').asfloat <> 0 then
    texto2 := FORMATFLOAT('###,###,##0.00', frmnotafiscal_menu.qrnota.fieldbyname('SEGURO').asfloat)
  else
    texto2 := '';
  if frmnotafiscal_menu.qrnota.fieldbyname('OUTRAS_DESPESAS').asfloat <> 0 then
    texto3 := FORMATFLOAT('###,###,##0.00', frmnotafiscal_menu.qrnota.fieldbyname('OUTRAS_DESPESAS').asfloat)
  else
    texto3 := '';
  if frmnotafiscal_menu.qrnota.fieldbyname('VALOR_TOTAL_IPI').asfloat <> 0 then
    texto4 := FORMATFLOAT('###,###,##0.00', frmnotafiscal_menu.qrnota.fieldbyname('VALOR_TOTAL_IPI').asfloat)
  else
    texto4 := '';
  if frmnotafiscal_menu.qrnota.fieldbyname('TOTAL_NOTA').asfloat <> 0 then
    texto5 := FORMATFLOAT('###,###,##0.00', frmnotafiscal_menu.qrnota.fieldbyname('TOTAL_NOTA').asfloat)
  else
    texto5 := '';
  write(arquivo, frmprincipal.Texto_Justifica(texto1, 24, ' ', 'E') + ' ');
  write(arquivo, frmprincipal.Texto_Justifica(texto2, 25, ' ', 'E') + ' ');
...
begin
  ...
  qrcliente.close;
  qrcliente.sql.clear;
  qrcliente.sql.add('select * from c000007 where atb like :atb and codigo = ''' + frmnotafiscal_menu.qrnota.fieldbyname('codcliente').asstring + '''');
  ...
  begin
    ...
    begin
      ...
      if frmnotafiscal.qrnotafiscal_item.fieldbyname('qtde').asfloat > 0 then
      ...
      if frmnotafiscal.qrnotafiscal_item.fieldbyname('unitario').asfloat > 0 then
      ...
      if frmnotafiscal.qrnotafiscal_item.fieldbyname('total').asfloat > 0 then
