object frmcfop: Tfrmcfop
  ...
  object pficha: TFlatPanel
    ...
    object Label14: TLabel
      ...
      Height = 13
      Caption = 
        'Configura'#231#227'o abaixo valida os dados no cadastro de produto para ' +
        'CFOP de venda no PDV'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Verdana'
  ...
  object cxPageControl1: TcxPageControl
    ...
    object cxTabSheet1: TcxTabSheet
      Caption = 'CSOSN Permitidos para o CFOP'
      ImageIndex = 0
    ...
    object cxTabSheet2: TcxTabSheet
      Caption = 'CST Permitidos para o CFOP'
      ImageIndex = 1
      ExplicitTop = 0
      ExplicitWidth = 776
      ExplicitHeight = 0
  ...
  object dscfop2: TDataSource
    DataSet = qrcfop
    OnStateChange = dscfop2StateChange
    Left = 238
    Top = 172
  end
  object qrcfop: TZQuery
    Connection = frmmodulo.Conexao
    AfterScroll = qrcfopAfterScroll
    SQL.Strings = (
      'select * from c000030')
    Params = <>
    Left = 342
  ...
  object qrcsosn: TZQuery
    ...
    object qrcsosnCFOP: TWideStringField
      FieldName = 'CFOP'
      Size = 5
    end
    object qrcsosnTIPO: TWideStringField
      FieldName = 'TIPO'
      Size = 1
    end
    object qrcsosnCSOSN: TWideStringField
      FieldName = 'CSOSN'
      Size = 3
    end
    object qrcsosnCST: TWideStringField
      FieldName = 'CST'
      Size = 3
    end
  end
  object dsCSOSN: TDataSource
    DataSet = frmmodulo.qrCSOSN
    Left = 552
    Top = 144
  end
