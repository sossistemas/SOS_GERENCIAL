object frmTabelaANP: TfrmTabelaANP
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'frmTabelaANP'
  ClientHeight = 513
  ClientWidth = 684
  Color = clBtnFace
  ...
  object qrExclui: TZQuery
    ...
    BeforePost = qrExcluiBeforePost
    AfterPost = qrExcluiAfterPost
    SQL.Strings = (
      'select count(*) qtd  from c000025 pr where pr.codigo_anp = :cod')
    Params = <
      item
        DataType = ftString
        Name = 'cod'
  ...
  object dsANP: TDataSource
    DataSet = qrANP
    OnStateChange = dsANPStateChange
    Left = 344
    Top = 136
  end
end
