object frmlista_cheque2: Tfrmlista_cheque2
  ...
  object qrcheque: TZQuery
    ...
    object dtfldEMISSAO: TDateField
      FieldName = 'EMISSAO'
    end
    object dtfldVENCIMENTO: TDateField
      FieldName = 'VENCIMENTO'
    end
    object dtfldDATA_DEPOSITO1: TDateField
      FieldName = 'DATA_DEPOSITO1'
    end
    object dtfldDATA_DEPOSITO2: TDateField
      FieldName = 'DATA_DEPOSITO2'
    end
    object dtfldDATA_DEVOLUCAO1: TDateField
      FieldName = 'DATA_DEVOLUCAO1'
    end
    object dtfldDATA_DEVOLUCAO2: TDateField
    ...
    object dtfldDATA_CONTA: TDateField
    ...
    object dtfldDATA_BAIXA: TDateField
    ...
    object qrchequeNOME: TWideStringField
      FieldName = 'NOME'
      Size = 80
    end
    object qrchequeTELEFONE1: TWideStringField
      FieldName = 'TELEFONE1'
    end
    object qrchequeTELEFONE2: TWideStringField
      FieldName = 'TELEFONE2'
    end
  end
end
