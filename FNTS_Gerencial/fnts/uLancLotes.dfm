object frmLancLotes: TfrmLancLotes
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'frmLancLotes'
  ClientHeight = 647
  ClientWidth = 1000
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object Label20: TLabel
      ...
      Width = 203
      Height = 23
      Caption = 'Lan'#231'amento de Lotes'
  ...
  object Panel3: TPanel
    ...
    object GroupBox2: TGroupBox
      ...
      TabOrder = 1
      object tjDTValidade: TJvDateEdit
        Left = 8
        Top = 36
        Width = 104
        Height = 21
        ...
        YearDigits = dyFour
        TabOrder = 0
        OnExit = tjDTValidadeExit
        OnKeyPress = tjDTValidadeKeyPress
        OnKeyDown = tjDTValidadeKeyDown
      end
      object tjValidade: TJvTimeEdit
        Left = 118
        Top = 36
        Width = 69
        Height = 21
        ...
        ShowHint = False
        TabOrder = 1
        OnKeyPress = tjValidadeKeyPress
      end
    end
    object cxDescricaoLote: TcxTextEdit
      Left = 359
      Top = 65
      ParentFont = False
      ...
      TabOrder = 2
      OnKeyPress = cxDescricaoLoteKeyPress
      Width = 282
    end
  end
  object Panel4: TPanel
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        object cxGrid1DBTableView1DESCPRODUTO: TcxGridDBColumn
          Caption = 'Descri'#231#227'o:'
        ...
        object cxGrid1DBTableView1PRECUSTO: TcxGridDBColumn
          Caption = 'Pre'#231'o Custo:'
          DataBinding.FieldName = 'PRECUSTO'
          Options.Editing = False
          Width = 81
        end
        object cxGrid1DBTableView1TOTALCUSTO: TcxGridDBColumn
          Caption = 'Total:'
          DataBinding.FieldName = 'TOTALCUSTO'
          Width = 79
        end
        object cxGrid1DBTableView1CODFORNEC: TcxGridDBColumn
          Caption = 'Cod. Fornecedor:'
          DataBinding.FieldName = 'CODFORNEC'
          Options.Editing = False
          Width = 109
        end
        object cxGrid1DBTableView1DESCFORNEC: TcxGridDBColumn
          Caption = 'Nome Fornecedor:'
          DataBinding.FieldName = 'DESCFORNEC'
          Options.Editing = False
          Width = 214
        end
  ...
  object GroupBox3: TGroupBox
    ...
    object Label10: TLabel
      ...
      Width = 112
      Height = 13
      Caption = 'Fabrica'#231#227'o do Produto:'
    end
    ...
    object cxCodigoProd: TcxTextEdit
      Left = 233
      Top = 44
      TabStop = False
      BeepOnEnter = False
    ...
    object JvDTValidadeProduto: TJvDateEdit
      Left = 529
      Top = 44
      Width = 120
      Height = 24
      ...
      YearDigits = dyFour
      TabOrder = 3
      OnExit = JvDTValidadeProdutoExit
      OnKeyPress = JvDTValidadeProdutoKeyPress
    end
    object cxUN: TcxTextEdit
      Left = 351
      Top = 44
      TabStop = False
      BeepOnEnter = False
    ...
    object cxQtdProd: TcxTextEdit
      ...
      Properties.CharCase = ecUpperCase
      Properties.OnChange = cxQtdProdPropertiesChange
      Style.Color = 15916445
      Style.Font.Charset = DEFAULT_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -13
      ...
      Style.IsFontAssigned = True
      TabOrder = 5
      OnExit = cxQtdProdExit
      OnKeyPress = cxQtdProdKeyPress
      Width = 113
    end
    object cxValCusto: TcxTextEdit
      Left = 122
      Top = 108
      BeepOnEnter = False
      ParentFont = False
      Properties.Alignment.Horz = taRightJustify
      Properties.CharCase = ecUpperCase
      Properties.OnChange = cxValCustoPropertiesChange
      Style.Color = 15916445
      Style.Font.Charset = DEFAULT_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -13
      ...
      Style.IsFontAssigned = True
      TabOrder = 6
      OnExit = cxValCustoExit
      OnKeyPress = cxValCustoKeyPress
      Width = 113
    end
    object cxValTotal: TcxTextEdit
      Left = 241
      Top = 108
      TabStop = False
      BeepOnEnter = False
      ...
      Style.IsFontAssigned = True
      TabOrder = 7
      OnKeyPress = cxValTotalKeyPress
      Width = 113
    end
    object cxbtInserir: TcxButton
      Left = 360
      Top = 102
      Width = 78
      Height = 35
      ...
      Font.Style = [fsBold]
      ParentFont = False
      OnClick = cxbtInserirClick
    end
    object jvDataFabricaProd: TJvDateEdit
      Left = 398
      Top = 44
      Width = 120
      Height = 24
      ...
      YearDigits = dyFour
      TabOrder = 9
      OnExit = jvDataFabricaProdExit
      OnKeyPress = jvDataFabricaProdKeyPress
    end
  end
  object ds1: TDataSource
    DataSet = cdsTempItensLote
    Left = 141
    Top = 341
  end
  object cdsTempItensLote: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 46
    Top = 350
    object cdsTempItensLoteID: TIntegerField
      FieldName = 'ID'
    end
    object cdsTempItensLoteCODPRODUTO: TStringField
      FieldName = 'CODPRODUTO'
      Size = 10
    end
    object cdsTempItensLoteDESCPRODUTO: TStringField
      FieldName = 'DESCPRODUTO'
      Size = 65
    end
    object cdsTempItensLoteUN: TStringField
      FieldName = 'UN'
      Size = 2
    end
    object cdsTempItensLoteQTD: TFloatField
      FieldName = 'QTD'
      DisplayFormat = '###,###,##0.000;'
    end
    object cdsTempItensLotePRECUSTO: TCurrencyField
      FieldName = 'PRECUSTO'
      DisplayFormat = '###,###,##0.00;'
    end
    object cdsTempItensLoteTOTALCUSTO: TCurrencyField
      FieldName = 'TOTALCUSTO'
      DisplayFormat = '###,###,##0.00;'
    end
    object cdsTempItensLoteCODFORNEC: TStringField
      FieldName = 'CODFORNEC'
      Size = 10
    end
    object cdsTempItensLoteDESCFORNEC: TStringField
      FieldName = 'DESCFORNEC'
      Size = 65
    end
    object cdsTempItensLoteFABRICACAO: TDateField
      FieldName = 'FABRICACAO'
    end
    object cdsTempItensLoteVALIDADE: TDateField
      FieldName = 'VALIDADE'
    end
    object cdsTempItensLoteIDLOTE: TIntegerField
      FieldName = 'IDLOTE'
    end
  end
end
