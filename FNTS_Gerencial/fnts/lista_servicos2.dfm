object frmlista_servicos2: Tfrmlista_servicos2
  Left = 446
  Top = 297
  BorderIcons = []
  BorderStyle = bsNone
  ...
  object fxservico: TfrxReport
    ...
    ReportOptions.LastChange = 39202.445228402780000000
  ...
  object FSSERVICO: TfrxDBDataset
    UserName = 'FSSERVICO'
  ...
  object qrservico: TZQuery
    ...
    object qrservicoGRUPO: TStringField
      FieldKind = fkLookup
      FieldName = 'GRUPO'
      LookupDataSet = frmmodulo.qrgrupo_servico
  ...
  object qrgrupo: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT COUNT(CODIGO) QTDE, CODGRUPO FROM C000011 GROUP BY CODGRU' +
        'PO')
    Params = <>
    Left = 136
    Top = 320
    object qrgrupoQTDE: TIntegerField
      FieldName = 'QTDE'
      ReadOnly = True
    end
    ...
    object qrgrupoCODGRUPO: TWideStringField
      FieldName = 'CODGRUPO'
      Size = 6
    end
  end
