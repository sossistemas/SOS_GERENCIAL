object frmManutencaoProduto: TfrmManutencaoProduto
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'frmManutencaoProduto'
  ClientHeight = 566
  ClientWidth = 825
  Color = clBtnFace
  ...
  object pnl1: TPanel
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        object cxGrid1DBTableView1ESTOQUEMINIMO: TcxGridDBColumn
          Caption = 'Est. Minimo'
          DataBinding.FieldName = 'ESTOQUEMINIMO'
          PropertiesClassName = 'TcxCalcEditProperties'
          Width = 65
        end
        object cxGrid1DBTableView1ESTOQUE_ATUAL: TcxGridDBColumn
          Caption = 'Estoque'
  ...
  object qrProduto: TZQuery
    ...
    AfterApplyUpdates = qrProdutoAfterApplyUpdates
    BeforeEdit = qrProdutoBeforeEdit
    AfterPost = qrProdutoAfterPost
    BeforeDelete = qrProdutoBeforeDelete
    SQL.Strings = (
      'select'
      '  pro.codigo,'
      '  pro.codbarra,'
      ...
      '  pro.usa_grade'
      'from c000025 pro'
      '  inner join c000100 est on est.codproduto = pro.codigo'
      '  where 1=1'
      'order by pro.codigo'
      '')
    Params = <>
  ...
  object qryTmp: TZQuery
    Connection = frmmodulo.Conexao
    Params = <>
    Left = 472
    Top = 293
  end
  object upProduto: TZUpdateSQL
    DeleteSQL.Strings = (
      'DELETE FROM c000025'
      'WHERE'
      '  c000025.CODIGO = :OLD_CODIGO')
    InsertSQL.Strings = (
      'INSERT INTO c000025'
      
        '  (CODIGO, CODBARRA, PRODUTO, UNIDADE, PRECOCUSTO, PRECOVENDA, E' +
        'STOQUEMINIMO, '
      '   USA_GRADE, ATIVA)'
      'VALUES'
      
        '  (:CODIGO, :CODBARRA, :PRODUTO, :UNIDADE, :PRECOCUSTO, :PRECOVE' +
        'NDA, :ESTOQUEMINIMO, '
      '   :USA_GRADE, :ATIVA)')
    ModifySQL.Strings = (
      'UPDATE c000025 SET'
