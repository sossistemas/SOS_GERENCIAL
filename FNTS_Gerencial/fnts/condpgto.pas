...
uses
  ...
  Mask, maskutils, Wwdbigrd, Wwdbgrid, AdvGlowButton, wwdblook, Vcl.Imaging.jpeg,
...
begin
  ...
  frmmodulo.qrcondpgto.SQL.add('select * from c000015 WHERE atb like :atb order by codigo');
...
begin
  try
    ...
    frmmodulo.qrcondpgto_parcela.SQL.add('delete from c000016 where atb like :atb and codcondpgto = ''' + frmmodulo.qrcondpgto.fieldbyname('codigo').asstring + '''');
    frmmodulo.qrcondpgto_parcela.ExecSQL;

    frmmodulo.qrcondpgto_parcela.SQL.clear;
    frmmodulo.qrcondpgto_parcela.SQL.add('select * from c000016 where atb like :atb and codcondpgto = ''' + frmmodulo.qrcondpgto.fieldbyname('codigo').asstring + ''' order by numero');
