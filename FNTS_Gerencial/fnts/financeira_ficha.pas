...
uses
  ...
  Dialogs, StdCtrls, Mask, RzEdit, RzBtnEdt, ExtCtrls, AdvGlowButton, Menus, DB, ZAbstractRODataset,
  ZDataset, ACBrEnterTab, AdvMetroButton,
  AdvSmoothExpanderPanel, JvExMask, JvToolEdit, ACBrBase, ZAbstractDataset,
  AdvSmoothPanel;
...
begin
  ...
  begin
    ...
    begin
      ...
      query.sql.add('atb like :atb and codigo = ''' + ed_cod_cliente.Text + '''');
