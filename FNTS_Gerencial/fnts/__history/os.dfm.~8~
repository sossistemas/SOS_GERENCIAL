object frmos: Tfrmos
  ...
  object PageView1: TPageView
    ...
    object PageSheet1: TPageSheet
      ...
      object gridservico: TwwDBGrid
        ...
        Selected.Strings = (
          'CODSERVICO'#9'6'#9'C'#243'digo'
          'SERVICO'#9'36'#9'Servi'#231'o'
          'COMPLEMENTO'#9'44'#9'Complemento'
          'VALOR'#9'10'#9'Valor'
          'CODTECNICO'#9'11'#9'Cod. T'#233'cnico'
          'Tecnico'#9'31'#9'T'#233'cnico')
  ...
  object qros_servico: TZQuery
    ...
    OnNewRecord = qros_servicoNewRecord
    SQL.Strings = (
      'SELECT * FROM C000053')
    Params = <>
    ...
    object qros_servicoATB: TWideStringField
      DisplayWidth = 30
      FieldName = 'ATB'
      Visible = False
      Size = 30
  ...
  object qrproduto_serial: TZQuery
    ...
    object qrproduto_serialATB: TWideStringField
      FieldName = 'ATB'
      Size = 30
    end
    object qrproduto_serialIDONLINE: TIntegerField
      FieldName = 'IDONLINE'
    end
  end
  ...
  object qros_produtos: TZQuery
    Connection = frmmodulo.Conexao
    OnNewRecord = qros_produtosNewRecord
    SQL.Strings = (
      'select * from c000032')
    Params = <>
    Left = 723
    ...
    object qros_produtosAIDF: TWideStringField
      FieldName = 'AIDF'
    end
    object qros_produtosVALIDADE: TWideStringField
      FieldName = 'VALIDADE'
    end
    object qros_produtosCSOSN: TWideStringField
      FieldName = 'CSOSN'
      Size = 10
    end
    object qros_produtosNFCE: TWideStringField
      FieldName = 'NFCE'
      Size = 1
    end
    object qros_produtosCLASSIFICACAO_FISCAL: TWideStringField
      FieldName = 'CLASSIFICACAO_FISCAL'
    end
    object qros_produtosBASE_SUB: TFloatField
      FieldName = 'BASE_SUB'
    end
    object qros_produtosICMS_SUB: TFloatField
      FieldName = 'ICMS_SUB'
    end
    object qros_produtosISENTAS_ICMS: TFloatField
      FieldName = 'ISENTAS_ICMS'
    end
    object qros_produtosOUTRAS_ICMS: TFloatField
      FieldName = 'OUTRAS_ICMS'
    end
    object qros_produtosGEROU_SAT: TWideStringField
      FieldName = 'GEROU_SAT'
      Size = 1
    end
    object qros_produtosNUMERO_SAT: TIntegerField
      FieldName = 'NUMERO_SAT'
    end
    object qros_produtosXITEM: TWideStringField
      FieldName = 'XITEM'
      Size = 30
    end
    object qros_produtosXPED: TWideStringField
      FieldName = 'XPED'
      Size = 15
    end
    object qros_produtosDEVOLVIDO: TWideStringField
      FieldName = 'DEVOLVIDO'
      Size = 1
    end
    object qros_produtosECF: TWideStringField
      FieldName = 'ECF'
      Size = 1
    end
    object qros_produtosPRECO_CUSTO: TFloatField
      FieldName = 'PRECO_CUSTO'
    end
    object qros_produtosIDONLINE: TIntegerField
      FieldName = 'IDONLINE'
    end
    object qros_produtosATB: TWideStringField
      FieldName = 'ATB'
      Size = 30
    end
  end
  object qrTecnico: TZQuery
    Connection = frmmodulo.Conexao
    SQL.Strings = (
      
        'select * from c000008 WHERE atb like :atb and SITUACAO = 1 AND F' +
        '_TECNICO = 1 order by nome')
    Params = <
      item
        DataType = ftUnknown
        Name = 'atb'
    ...
    object qrTecnicoCODIGO: TWideStringField
      FieldName = 'CODIGO'
      Required = True
      Size = 6
    end
    object qrTecnicoNOME: TWideStringField
      FieldName = 'NOME'
      Size = 80
    end
    object qrTecnicoENDERECO: TWideStringField
      FieldName = 'ENDERECO'
      Size = 80
    end
    object qrTecnicoBAIRRO: TWideStringField
      FieldName = 'BAIRRO'
      Size = 30
    end
    object qrTecnicoCIDADE: TWideStringField
      FieldName = 'CIDADE'
      Size = 40
    end
    object qrTecnicoUF: TWideStringField
      FieldName = 'UF'
      Size = 2
    end
    object qrTecnicoCEP: TWideStringField
      FieldName = 'CEP'
      Size = 10
    end
    object qrTecnicoTELEFONE: TWideStringField
      FieldName = 'TELEFONE'
    end
    object qrTecnicoCELULAR: TWideStringField
      FieldName = 'CELULAR'
    end
    object qrTecnicoEMAIL: TWideStringField
      FieldName = 'EMAIL'
      Size = 50
    end
    object qrTecnicoCPF: TWideStringField
      FieldName = 'CPF'
      Size = 15
    end
    object qrTecnicoRG: TWideStringField
      FieldName = 'RG'
      Size = 25
    end
    object qrTecnicoCTPS: TWideStringField
      FieldName = 'CTPS'
      Size = 25
    end
    object qrTecnicoFUNCAO: TWideStringField
      FieldName = 'FUNCAO'
      Size = 30
    end
    object qrTecnicoDATA_ADMISSAO: TDateField
      FieldName = 'DATA_ADMISSAO'
    end
    object qrTecnicoDATA_DEMISSAO: TDateField
      FieldName = 'DATA_DEMISSAO'
    end
    object qrTecnicoSITUACAO: TIntegerField
      FieldName = 'SITUACAO'
    end
    object qrTecnicoSALARIO: TFloatField
      FieldName = 'SALARIO'
    end
    object qrTecnicoCOMISSAO: TFloatField
      FieldName = 'COMISSAO'
    end
    object qrTecnicoOBS1: TWideStringField
      FieldName = 'OBS1'
      Size = 80
    end
    object qrTecnicoOBS2: TWideStringField
      FieldName = 'OBS2'
      Size = 80
    end
    object qrTecnicoOBS3: TWideStringField
      FieldName = 'OBS3'
      Size = 80
    end
    object qrTecnicoNASCIMENTO: TDateField
      FieldName = 'NASCIMENTO'
    end
    object qrTecnicoF_CAIXA: TIntegerField
      FieldName = 'F_CAIXA'
    end
    object qrTecnicoF_VENDEDOR: TIntegerField
      FieldName = 'F_VENDEDOR'
    end
    object qrTecnicoF_TECNICO: TIntegerField
      FieldName = 'F_TECNICO'
    end
    object qrTecnicoNUMERO: TWideStringField
      FieldName = 'NUMERO'
      Size = 10
    end
    object qrTecnicoSENHA: TWideStringField
      FieldName = 'SENHA'
    end
    object qrTecnicoATIVA: TWideStringField
      FieldName = 'ATIVA'
      Size = 10
    end
    object qrTecnicoAPROVA_DESCONTO: TWideStringField
      FieldName = 'APROVA_DESCONTO'
      Size = 1
    end
    object qrTecnicoABRIR_CAIXA: TWideStringField
      FieldName = 'ABRIR_CAIXA'
      Size = 1
    end
    object qrTecnicoFECHA_CAIXA: TWideStringField
      FieldName = 'FECHA_CAIXA'
      Size = 1
    end
    object qrTecnicoCONFIGURACOES: TWideStringField
      FieldName = 'CONFIGURACOES'
      Size = 1
    end
    object qrTecnicoCANCELAR_VENDA: TWideStringField
      FieldName = 'CANCELAR_VENDA'
      Size = 1
    end
    object qrTecnicoCANCELAR_ITEM: TWideStringField
      FieldName = 'CANCELAR_ITEM'
      Size = 1
    end
    object qrTecnicoATB: TWideStringField
      FieldName = 'ATB'
      Size = 30
    end
  end
