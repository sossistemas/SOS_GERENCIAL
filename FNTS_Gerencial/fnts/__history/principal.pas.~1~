...
begin
  ...
  begin
    ...
    begin
      if application.messagebox(Pchar('A Data do Caixa est· diferente da atual!' + #13 + 'Deseja fechar o caixa do dia ' + qrcx.FIELDBYNAME('data').asstring + '?'), 'AtenÁ„o', MB_IconInformation + MB_YESNO) = idYes then
      begin
        Action5.Execute
      end;
    end;
