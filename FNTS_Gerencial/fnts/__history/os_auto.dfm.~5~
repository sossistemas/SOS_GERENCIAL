object frmOS_Auto: TfrmOS_Auto
  ...
  object qros_produto: TZQuery
    Connection = frmmodulo.Conexao
    OnNewRecord = qros_produtoNewRecord
    SQL.Strings = (
      'select * from c000032')
    Params = <>
    Left = 264
    ...
    object qros_produtoAIDF: TWideStringField
      FieldName = 'AIDF'
    end
    object qros_produtoVALIDADE: TWideStringField
      FieldName = 'VALIDADE'
    end
    object qros_produtoCSOSN: TWideStringField
      FieldName = 'CSOSN'
      Size = 10
    end
    object qros_produtoNFCE: TWideStringField
      FieldName = 'NFCE'
      Size = 1
    end
    object qros_produtoCLASSIFICACAO_FISCAL: TWideStringField
      FieldName = 'CLASSIFICACAO_FISCAL'
    end
    object qros_produtoBASE_SUB: TFloatField
      FieldName = 'BASE_SUB'
    end
    object qros_produtoICMS_SUB: TFloatField
      FieldName = 'ICMS_SUB'
    end
    object qros_produtoISENTAS_ICMS: TFloatField
      FieldName = 'ISENTAS_ICMS'
    end
    object qros_produtoOUTRAS_ICMS: TFloatField
      FieldName = 'OUTRAS_ICMS'
    end
    object qros_produtoGEROU_SAT: TWideStringField
      FieldName = 'GEROU_SAT'
      Size = 1
    end
    object qros_produtoNUMERO_SAT: TIntegerField
      FieldName = 'NUMERO_SAT'
    end
    object qros_produtoXITEM: TWideStringField
      FieldName = 'XITEM'
      Size = 30
    end
    object qros_produtoXPED: TWideStringField
      FieldName = 'XPED'
      Size = 15
    end
    object qros_produtoDEVOLVIDO: TWideStringField
      FieldName = 'DEVOLVIDO'
      Size = 1
    end
    object qros_produtoECF: TWideStringField
      FieldName = 'ECF'
      Size = 1
    end
    object qros_produtoPRECO_CUSTO: TFloatField
      FieldName = 'PRECO_CUSTO'
    end
    object qros_produtoIDONLINE: TIntegerField
      FieldName = 'IDONLINE'
    end
    object qros_produtoATB: TWideStringField
      FieldName = 'ATB'
      Required = True
      Size = 30
    end
  ...
  object qrOS_contasreceber: TZQuery
    ...
    object qrOS_contasreceberVENCIMENTO: TDateField
      FieldName = 'VENCIMENTO'
    end
