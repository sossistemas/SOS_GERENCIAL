object frmUnidades: TfrmUnidades
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = dsImpressora
      ...
      object cxGrid1DBTableView1UNI_NFE: TcxGridDBColumn
        Caption = 'Un. NF-e'
        DataBinding.FieldName = 'UNI_NFE'
        Width = 66
      end
    end
  ...
  object qrUnidade: TZQuery
    ...
    BeforePost = qrUnidadeBeforePost
    AfterPost = qrUnidadeAfterPost
    OnPostError = qrUnidadePostError
    SQL.Strings = (
      'select * from unidade')
    Params = <>
    Left = 204
  ...
  object dsImpressora: TDataSource
    DataSet = qrUnidade
    OnStateChange = dsImpressoraStateChange
    Left = 288
    Top = 192
  end
  object qrExclui: TZQuery
    Connection = frmmodulo.Conexao
    SQL.Strings = (
      'select count(*) qtd  from unidade un where un.unidade = :un')
    Params = <
      item
        DataType = ftString
        Name = 'un'
    ...
    object qrExcluiQTD: TIntegerField
      FieldName = 'QTD'
      ReadOnly = True
    end
  end
  object qrDup: TZQuery
    Connection = frmmodulo.Conexao
    SQL.Strings = (
      'select count(*) qtd from UNIDADE un where un.unidade = :un')
    Params = <
