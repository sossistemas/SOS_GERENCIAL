object frmcontaspagar_data: Tfrmcontaspagar_data
  Left = 183
  Top = 308
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'CONTAS A PAGAR | Alterar data de Pagamento'
  ClientHeight = 126
  ClientWidth = 364
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    Width = 257
    Height = 49
    Caption = 'Informe a nova data do Pagamento'
    TabOrder = 0
  ...
  object dscontaspagar: TDataSource
    DataSet = frmcontaspagar.qrcontaspagar
    Left = 432
    Top = 240
  end
