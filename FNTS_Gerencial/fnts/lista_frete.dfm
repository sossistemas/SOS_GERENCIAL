object frmlista_frete: Tfrmlista_frete
  Left = 859
  Top = 328
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'FRETE | Relat'#243'rios'
  ClientHeight = 225
  ClientWidth = 414
  Color = clBtnFace
  ...
  object combo_relatorio: TComboBox
    ...
    Items.Strings = (
      'RELA'#199#195'O POR VE'#205'CULO'
      'RELA'#199#195'O POR MOTORISTA')
  end
  ...
  object fxnota: TfrxReport
    ...
    ReportOptions.LastChange = 39836.714773935200000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo25: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Resumo de Frete - por Ve'#237'culo')
          ParentFont = False
        end
      ...
      object Footer1: TfrxFooter
        ...
        object Memo13: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<fsfrete."FRETE_VALOR">,MasterData1)]')
          ParentFont = False
        end
  ...
  object qrfrete: TZQuery
    Connection = frmmodulo.econexao2
    SQL.Strings = (
      'select '
      'venda.*,'
      'transp.nome nome_transportador,'
      ...
      'c000007 cliente'
      'where'
      'venda.codtransportador = transp.codigo'
      'and'
      'venda.codveiculo = veiculo.codigo'
      'and'
