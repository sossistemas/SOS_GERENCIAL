...
uses
  ...
  Wwdbgrid, DB, Buttons, Menus, frxDesgn, frxClass, frxDBSet,
  Mask, AdvGlowButton, JvMemoryDataset, JvExMask, JvToolEdit, JvBaseEdits;
...
type
  Tfrmcontasreceber_movimentacao = class(TForm)
    ...
    Fechar1: TMenuItem;
    qrvenda_produtos: TJvMemoryData;
...
uses contasreceber, modulo, principal, dados_cliente;
...
begin
  ...
  fxvenda_produto.LoadFromFile('C:\SOS\Server\rel\F000131.fr3');
