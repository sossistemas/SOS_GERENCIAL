object frmgrupo_servico: Tfrmgrupo_servico
  Left = 410
  Top = 420
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'GRUPO DE SERVI'#199'OS | Rela'#231#227'o'
  ClientHeight = 362
  ClientWidth = 563
  Color = 5460819
  ...
  object qrgrupo_servico: TZQuery
    ...
    BeforePost = qrgrupo_servicoBeforePost
    AfterPost = qrgrupo_servicoAfterPost
