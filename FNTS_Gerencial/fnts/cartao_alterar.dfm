object frmcartao_alterar: Tfrmcartao_alterar
  Left = 324
  Top = 364
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'CART'#195'O | Alterar'
  ClientHeight = 326
  ClientWidth = 689
  Color = 11429670
  ...
  object pnl1: TPanel
    ...
    object ed_comissao: TRzNumericEdit
      Left = 112
      Top = 149
      Width = 113
      Height = 21
      TabOnEnter = True
      TabOrder = 8
      OnExit = ed_comissaoExit
      IntegersOnly = False
      DisplayFormat = 'R$ ###,###,##0.00'
    end
    object ed_liquido: TRzNumericEdit
      Left = 112
      Top = 173
      Width = 113
      Height = 21
    ...
    object cb_tipo: TComboBox
      ...
      TabOrder = 10
      Text = 'CREDITO'
      OnKeyPress = cb_tipoKeyPress
      Items.Strings = (
        'CREDITO'
        'DEBITO')
    end
    object spin_parcela: TRzSpinEdit
      Left = 280
      Top = 197
      Width = 47
      Height = 21
      ...
      TabOrder = 11
      OnKeyPress = spin_parcelaKeyPress
    end
  end
