...
uses
  ...
  RzEdit, AdvMetroButton, AdvSmoothPanel, AdvSmoothExpanderPanel, JvExMask,
...
uses modulo, principal, xloc_produto, os_auto,
  os_serial;
...
begin
  ...
  begin
    ...
    frmOS_Auto.qros_produto.fieldbyname('produto').asstring := eproduto.text;
    ...
    frmOS_Auto.qros_produto.fieldbyname('codnota').asstring := frmmodulo.cdsos.fieldbyname('codigo').asstring;
    frmOS_Auto.qros_produto.fieldbyname('data').asstring := frmmodulo.cdsos.fieldbyname('data').asstring;
    frmOS_Auto.qros_produto.fieldbyname('codcliente').asstring := frmmodulo.cdsos.fieldbyname('codcliente').asstring;
    frmOS_Auto.qros_produto.fieldbyname('codvendedor').asstring := frmmodulo.cdsos.fieldbyname('codatendente').asstring;
    ...
    begin
      ...
      frmOS_Auto.QRPRODUTO_SERIAL.fieldbyname('cliente').asstring := frmmodulo.cdsos.fieldbyname('cliente').asstring;
      frmOS_Auto.QRPRODUTO_SERIAL.fieldbyname('codcliente').asstring := frmmodulo.cdsos.fieldbyname('codcliente').asstring;

      frmOS_Auto.QRPRODUTO_SERIAL.FieldByName('DATAvenda').ASSTRING := frmmodulo.cdsos.fieldbyname('data').asstring;
      frmOS_Auto.qrproduto_serial.fieldbyname('codvenda').asstring := frmmodulo.cdsos.fieldbyname('codigo').asstring;
