...
begin
  ...
  if frmmodulo.qrFILIAL.RecordCount = 0 then begin
    Application.MessageBox('Não foi localizado uma empresa cadastrada para a Área de Trabalho ativa, será iniciado um novo cadastro automáticamente.!','Atenção!',MB_ICONINFORMATION);
