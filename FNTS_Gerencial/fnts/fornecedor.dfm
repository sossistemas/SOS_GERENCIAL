object frmfornecedor: Tfrmfornecedor
  ...
  object ImageList1: TImageList
    ...
    Top = 241
    Bitmap = {
      494C01010600090024000F000F00FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object qrsugestao: TZQuery
    ...
    object qrsugestaoORIGEM: TIntegerField
      FieldName = 'ORIGEM'
    end
    object qrsugestaoIND_CFOP_NFCE: TWideStringField
      FieldName = 'IND_CFOP_NFCE'
      Size = 4
    end
    object qrsugestaoFOTOBD: TBlobField
      FieldName = 'FOTOBD'
    end
    object qrsugestaoID_TIPO_SERVICO: TIntegerField
      FieldName = 'ID_TIPO_SERVICO'
    end
    object qrsugestaoNAO_MOVIMENTA_ESTOQUE: TWideStringField
      FieldName = 'NAO_MOVIMENTA_ESTOQUE'
      Size = 1
    end
    object qrsugestaoPESAGEM_AUOTMATICA: TWideStringField
      FieldName = 'PESAGEM_AUOTMATICA'
      Size = 1
    end
    object qrsugestaoINFORMA_CODIGO_BARRA_XML: TWideStringField
      FieldName = 'INFORMA_CODIGO_BARRA_XML'
      Size = 1
    end
    object qrsugestaoCODIGO_ANP: TWideStringField
      FieldName = 'CODIGO_ANP'
      Size = 10
    end
    object qrsugestaoCOMBO: TWideStringField
      FieldName = 'COMBO'
      Size = 1
    end
    object qrsugestaoIND_CFOP_DEV_COMPRA_DENTRO: TWideStringField
      FieldName = 'IND_CFOP_DEV_COMPRA_DENTRO'
      Size = 6
    end
    object qrsugestaoIND_CFOP_DEV_COMPRA_FORA: TWideStringField
      FieldName = 'IND_CFOP_DEV_COMPRA_FORA'
      Size = 6
    end
    object qrsugestaoPIZZA: TWideStringField
      FieldName = 'PIZZA'
      Size = 1
    end
    object qrsugestaoPERCGLNN: TFloatField
      FieldName = 'PERCGLNN'
    end
    object qrsugestaoPERCGLGNI: TFloatField
      FieldName = 'PERCGLGNI'
    end
    object qrsugestaoPGLP: TFloatField
      FieldName = 'PGLP'
    end
    object qrsugestaoVPART: TFloatField
      FieldName = 'VPART'
    end
    object qrsugestaoECF_ICMS: TWideStringField
      FieldName = 'ECF_ICMS'
      Size = 30
    end
  end
