...
uses
  ...
  ZAbstractDataset, ZDataset, wwdblook, Menus, AdvGlowButton, JvToolEdit,
...
begin
  ...
  CobreBemX.PadroesBoleto.PadroesBoletoImpresso.CaminhoImagensCodigoBarras := 'C:\SOS\server\cob\CobreBemX\Imagens\';
