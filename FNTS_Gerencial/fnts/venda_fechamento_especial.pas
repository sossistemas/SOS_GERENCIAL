...
uses
  ...
  RzSpnEdt, AdvMetroButton, AdvSmoothExpanderPanel, JvExMask,
  JvToolEdit, JvBaseEdits, AdvSmoothPanel, RzEdit;
...
uses modulo, venda, principal, Data.DB;
...
begin
  ...
  begin
    ...
    FRMMODULO.qrvendaOBS1.AsString := frmvenda.ObservacoesVenda.Obs1;
    FRMMODULO.qrvendaOBS2.AsString := frmvenda.ObservacoesVenda.Obs2;
    FRMMODULO.qrvendaOBS3.AsString := frmvenda.ObservacoesVenda.Obs3;
    FRMMODULO.qrvendaOBS4.AsString := frmvenda.ObservacoesVenda.Obs4;
