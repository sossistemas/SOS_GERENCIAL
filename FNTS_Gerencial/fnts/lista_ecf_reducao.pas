...
type
  Tfrmlista_ecf_reducao = class(TForm)
    ...
    qrreducaoMOVIMENTO: TWideStringField;
    qrreducaoCODIGO_EMPRESA: TIntegerField;
    qrreducaoOBS1: TWideStringField;
    qrreducaoCNPJ: TWideStringField;
    qrreducaoIE: TWideStringField;
    qrreducaoUF: TWideStringField;
    qrreducaoCODIGO_CLIENTE: TIntegerField;
    qrreducaoCNPJ_CLIENTE: TWideStringField;
    qrreducaoIE_CLIENTE: TWideStringField;
    qrreducaoUF_CLIENTE: TWideStringField;
    qrreducaoCFOP: TWideStringField;
    qrreducaoCOD_SINTEGRA_R60: TWideStringField;
    qrreducaoDATA_EMISSAO: TDateTimeField;
    qrreducaoNRO_SERIE_EQP: TWideStringField;
    qrreducaoNRO_ORDEM_EQP: TIntegerField;
    qrreducaoMODELO_DOC: TWideStringField;
    ...
    qrreducaoBRANCOS: TWideStringField;
    qrreducaoDATAHORA_RECEBIMENTO: TDateTimeField;
    qrreducaoMODELO_NF: TWideStringField;
    ...
    qrreducaoBRANCOS_60A01: TWideStringField;
    qrreducaoBRANCOS_60A02: TWideStringField;
    qrreducaoBRANCOS_60A03: TWideStringField;
    qrreducaoBRANCOS_60A04: TWideStringField;
    qrreducaoBRANCOS_60A05: TWideStringField;
    qrreducaoTOTAL_INICIO_DIA: TFloatField;
    qrreducaoTOTAL_FINAL_DIA: TFloatField;
    qrreducaoTOTAL_DIA: TFloatField;
    qrreducaoOBSERVACAO: TWideStringField;
    qrreducaoVALOR_VENDA_LIQUIDA: TFloatField;
    qrreducaoNRO_CONTADOR_CANCELAMENTO: TIntegerField;
    qrmapa_resumoDATA: TDateTimeField;
    qrmapa_resumoCONTROLE: TWideStringField;
...
begin
  ...
  begin
    ...
    FXNOTA.LoadFromFile('\SOS\server\rel\f000092.fr3');
    FXNOTA.ShowReport;
  ...
  begin
    ...
    begin
      ...
      if combo_relatorio.Text = 'MAPA RESUMO ECF' then
        FXNOTA.LoadFromFile('\SOS\server\rel\f000140.fr3')
      else
        FXNOTA.LoadFromFile('\SOS\server\rel\f000140_1.fr3');
      FXNOTA.ShowReport;
    end
    else
    begin
