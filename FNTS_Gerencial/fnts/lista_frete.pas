...
uses
  ...
  frxDBSet, frxDesgn, Menus, AdvGlowButton, DBAccess, JvExMask,
  JvToolEdit;
...
begin
  ...
  if combo_relatorio.ItemIndex = 0 then FXNOTA.LoadFromFile('\SOS\server\rel\f000190.fr3');
  if combo_relatorio.ItemIndex = 1 then FXNOTA.LoadFromFile('\SOS\server\rel\f000190_2.fr3');
...
begin
  ...
  begin
    FXNOTA.LoadFromFile('\SOS\server\rel\f000190.fr3');
    FXNOTA.DesignReport;
  end;
  if combo_relatorio.itemindex = 1 then
  begin
    FXNOTA.LoadFromFile('\SOS\server\rel\f000190_2.fr3');
    FXNOTA.DesignReport;
  end;
