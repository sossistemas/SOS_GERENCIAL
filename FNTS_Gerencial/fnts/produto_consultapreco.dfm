object frmproduto_consultapreco: Tfrmproduto_consultapreco
  ...
  object query: TZQuery
    ...
    object queryORIGEM: TIntegerField
      FieldName = 'ORIGEM'
    end
    object queryIND_CFOP_NFCE: TWideStringField
      FieldName = 'IND_CFOP_NFCE'
      Size = 4
    end
    object queryFOTOBD: TBlobField
      FieldName = 'FOTOBD'
    end
    object queryID_TIPO_SERVICO: TIntegerField
      FieldName = 'ID_TIPO_SERVICO'
    end
    object queryNAO_MOVIMENTA_ESTOQUE: TWideStringField
      FieldName = 'NAO_MOVIMENTA_ESTOQUE'
      Size = 1
    end
    object queryPESAGEM_AUOTMATICA: TWideStringField
      FieldName = 'PESAGEM_AUOTMATICA'
      Size = 1
    end
    object queryINFORMA_CODIGO_BARRA_XML: TWideStringField
      FieldName = 'INFORMA_CODIGO_BARRA_XML'
      Size = 1
    end
    object queryCODIGO_ANP: TWideStringField
      FieldName = 'CODIGO_ANP'
      Size = 10
    end
    object queryCOMBO: TWideStringField
      FieldName = 'COMBO'
      Size = 1
    end
    object queryIND_CFOP_DEV_COMPRA_DENTRO: TWideStringField
      FieldName = 'IND_CFOP_DEV_COMPRA_DENTRO'
      Size = 6
    end
    object queryIND_CFOP_DEV_COMPRA_FORA: TWideStringField
      FieldName = 'IND_CFOP_DEV_COMPRA_FORA'
      Size = 6
    end
    object queryPIZZA: TWideStringField
      FieldName = 'PIZZA'
      Size = 1
    end
    object queryPERCGLNN: TFloatField
      FieldName = 'PERCGLNN'
    end
    object queryPERCGLGNI: TFloatField
      FieldName = 'PERCGLGNI'
    end
    object queryPGLP: TFloatField
      FieldName = 'PGLP'
    end
    object queryVPART: TFloatField
      FieldName = 'VPART'
    end
    object queryECF_ICMS: TWideStringField
      FieldName = 'ECF_ICMS'
      Size = 30
    end
  end
