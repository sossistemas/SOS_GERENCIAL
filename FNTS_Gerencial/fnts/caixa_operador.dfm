object frmCaixa_operador: TfrmCaixa_operador
  ...
  object pficha: TFlatPanel
    ...
    object ckCaixaGeral: TcxDBCheckBox
      Left = 170
      Top = 20
      Caption = 'Caixa Geral'
      DataBinding.DataField = 'CAIXA_GERAL'
      DataBinding.DataSource = dscaixa_operador2
      Properties.NullStyle = nssUnchecked
      Properties.ValueChecked = 'S'
      Properties.ValueUnchecked = 'N'
      Properties.OnEditValueChanged = ckCaixaGeralPropertiesEditValueChanged
      TabOrder = 5
    end
    ...
    object bloccaixa_operador: TcxButton
      Left = 172
      Top = 45
      Width = 30
      Height = 25
  ...
  object qrGeral: TZQuery
    Connection = frmmodulo.Conexao
    SQL.Strings = (
      
        'select count(*) qtd from c000045 cx where cx.atb = :atb and  cx.' +
        'codigo <> '#39'0000001'#39' and cx.caixa_geral = '#39'S'#39)
    Params = <
      item
        DataType = ftUnknown
        Name = 'atb'
    ...
    object qrGeralQTD: TIntegerField
      FieldName = 'QTD'
      ReadOnly = True
    end
  end
