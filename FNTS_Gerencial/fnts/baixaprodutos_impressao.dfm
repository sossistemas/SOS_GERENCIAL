object frmbaixaestoque_impressao: Tfrmbaixaestoque_impressao
  Left = 194
  Top = 115
  Width = 467
  Height = 199
  Caption = 'BAIXA DE PRODUTOS - Aviso de Impress'#227'o'
  Color = clBtnFace
  ...
  object fsitembaixa_produtos: TfrxDBDataset
    ...
    DataSet = frmmodulo.qritem_baixa_produtos
    BCDToCurrency = False
    Left = 368
    Top = 88
  end
  object fsorcamento_receber: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'DOCUMENTO=DOCUMENTO'
      'CODORCAMENTO=CODORCAMENTO')
    DataSet = frmbaixa_estoque.qritem_baixa_produtos
    BCDToCurrency = False
    Left = 368
    Top = 120
  end
