object frmItensOrcamento: TfrmItensOrcamento
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      object ColxPed: TcxGridDBColumn
        DataBinding.FieldName = 'XPED'
        Width = 52
      end
      object ColxItem: TcxGridDBColumn
        DataBinding.FieldName = 'XITEM'
        Width = 100
      end
    end
  ...
  object qrItens: TZQuery
    ...
    SQL.Strings = (
      'SELECT '#39'S'#39' as sel, orc.* FROM C000057 orc')
    Params = <>
    Left = 219
    Top = 147
    ...
    object qrItensCODORCAMENTO: TWideStringField
    ...
    object qrItensNCM: TWideStringField
      FieldName = 'NCM'
    end
    object qrItensLOTE: TWideStringField
      FieldName = 'LOTE'
      Size = 30
    end
    object qrItensIND: TIntegerField
      FieldName = 'IND'
    end
    object qrItensNUMERACAO: TWideStringField
      FieldName = 'NUMERACAO'
      Size = 10
    end
    ...
    object qrItensICMS: TWideStringField
      FieldName = 'ICMS'
      Size = 10
    end
    ...
    object qrItensITEM: TWideStringField
      FieldName = 'ITEM'
      Size = 3
    end
    object qrItensTERMINAL: TWideStringField
      FieldName = 'TERMINAL'
      Size = 6
    end
    ...
    object qrItensPISCOFINS: TWideStringField
      FieldName = 'PISCOFINS'
      Size = 3
    end
    object qrItensSERIAL_CODINT: TWideStringField
      FieldName = 'SERIAL_CODINT'
      Size = 6
    end
    object qrItensGRADE_CODINT: TWideStringField
      FieldName = 'GRADE_CODINT'
      Size = 6
    end
    object qrItensOBS: TWideStringField
      FieldName = 'OBS'
      Size = 60
    end
    object qrItensSEL: TWideStringField
      FieldName = 'SEL'
      Size = 1
    end
    object qrItensXITEM: TWideStringField
      FieldName = 'XITEM'
      Size = 30
    end
    object qrItensXPED: TWideStringField
      FieldName = 'XPED'
      Size = 15
    end
  end
