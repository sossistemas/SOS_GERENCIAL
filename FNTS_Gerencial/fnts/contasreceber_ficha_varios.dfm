object frmcontasreceber_ficha_varios: Tfrmcontasreceber_ficha_varios
  Left = 408
  Top = 240
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'Contas a Receber - Lan'#231'amento em Grupo'
  ClientHeight = 460
  ClientWidth = 679
  Color = clBtnFace
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Selected.Strings = (
      ...
      'DOCUMENTO'#9'24'#9'Documento'
      'VALOR'#9'17'#9'Valor-R$')
