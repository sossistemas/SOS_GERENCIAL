...
uses
  ...
  Grids, Wwdbigrd, Wwdbgrid, ExtCtrls, DB, ZAbstractRODataset,
  ZDataset, Menus, wwdbedit, Wwdotdot, Wwdbcomb,
  AdvGlowButton, wwdblook, AdvMetroButton,
...
procedure Tfrmcontasreceber_ficha_varios.AdvMetroButton1Click(Sender: TObject);
begin
  close;
end;
