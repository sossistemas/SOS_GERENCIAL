...
uses
  ...
  DBCtrls, DB, Menus, AdvGlowButton, RzDBEdit, ACBrEnterTab,
  AdvMetroButton, AdvSmoothExpanderPanel, ACBrBase, AdvSmoothPanel, RzEdit;
...
uses
  caixa, loc_conta, modulo, principal;
...
begin
  ...
  begin
    ...
    frmprincipal.logUC('Incluiu ou Alterou Movimento Entrada Caixa - ' + FRMCAIXA.QRCAIXA_MOV.FIELDBYNAME('historico').asstring, 2);
  end
  else
  begin
    ...
    frmprincipal.logUC('Incluiu ou Alterou Movimento Saida Caixa - ' + FRMCAIXA.QRCAIXA_MOV.FIELDBYNAME('historico').asstring, 2);
  end;
