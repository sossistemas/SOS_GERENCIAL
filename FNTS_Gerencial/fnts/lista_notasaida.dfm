object frmlista_notasaida: Tfrmlista_notasaida
  ...
  object combo_situacao: TComboBox
    ...
    Items.Strings = (
      'Todas'
      'G - Aguardando Valida'#231#227'o'
      'V - Validada'
      'E - Enviada, Aguardando Retorno'
      'A - Aceita'
      'R - Rejeitada'
      'C - Cancelada')
  end
  ...
  object AdvSmoothExpanderPanel1: TAdvSmoothExpanderPanel
    ...
    object Label53: TLabel
      ...
      Width = 364
      Height = 23
      Caption = 'Relat'#243'rio de Emiss'#227'o de Notas Fiscais'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -19
      Font.Name = 'Verdana'
  ...
  object qrnota: TZQuery
    ...
    object dtfldFATURAMENTO_DATA1: TDateField
      FieldName = 'FATURAMENTO_DATA1'
    end
    object dtfldFATURAMENTO_DATA2: TDateField
      FieldName = 'FATURAMENTO_DATA2'
    end
    object dtfldFATURAMENTO_DATA3: TDateField
      FieldName = 'FATURAMENTO_DATA3'
    end
    object dtfldFATURAMENTO_DATA4: TDateField
    ...
    object dtfldDATA_SAIDA: TDateField
    ...
    object dtfldFATURAMENTO_DATA5: TDateField
      FieldName = 'FATURAMENTO_DATA5'
    end
    object dtfldFATURAMENTO_DATA6: TDateField
    ...
    object dtfldFATURAMENTO_DATA7: TDateField
      FieldName = 'FATURAMENTO_DATA7'
    end
    object dtfldFATURAMENTO_DATA8: TDateField
      FieldName = 'FATURAMENTO_DATA8'
    end
    object dtfldFATURAMENTO_DATA9: TDateField
    ...
    object qrnotaNATUREZA: TWideStringField
      FieldName = 'NATUREZA'
    end
  ...
  object qrnota_item: TZQuery
    ...
    object qrnota_itemCEST: TWideStringField
      FieldName = 'CEST'
      Size = 7
    end
  end
