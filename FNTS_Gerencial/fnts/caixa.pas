...
uses
  ...
  Dialogs, ExtCtrls, StdCtrls, TFlatPanelUnit, Mask, Grids, Wwdbigrd,
...
uses
  ...
  caixa_ficha, lista_caixa2, FechamentoCegoConciliar;
...
begin
  ...
  begin
    ...
    Qrsoma.SQL.add('select sum(entrada) total_entrada, sum(saida) total_saida, ' + // total_entrada e total_saida
      '(select sum(VALOR) VALOR    from c000044 where ATB like :ATB AND movimento = 03 and data = :data_caixa), ' + // sum
      '(select sum(VALOR) VALOR_1  from c000044 where ATB like :ATB AND movimento = 04 and data = :data_caixa), ' + // sum_1
      '(select sum(VALOR) VALOR_2  from c000044 where ATB like :ATB AND movimento = 05 and data = :data_caixa), ' + // sum_2
      '(select sum(VALOR) VALOR_3  from c000044 where ATB like :ATB AND movimento = 06 and data = :data_caixa), ' + // sum_3
      '(select sum(VALOR) VALOR_4  from c000044 where ATB like :ATB AND movimento = 07 and data = :data_caixa), ' + // sum_4
      '(select sum(VALOR) VALOR_5  from c000044 where ATB like :ATB AND movimento = 08 and data = :data_caixa), ' + // sum_5
      // ordem de servico
      '(select sum(VALOR) VALOR_6  from c000044 where ATB like :ATB AND movimento = 18 and data = :data_caixa),  ' + // sum_6  - dinheiro
      '(select sum(VALOR) VALOR_7  from c000044 where ATB like :ATB AND movimento = 19 and data = :data_caixa),  ' + // sum_7  - cree
      '(select sum(VALOR) VALOR_8  from c000044 where ATB like :ATB AND movimento = 20 and data = :data_caixa),  ' + // sum_8  - cv
      '(select sum(VALOR) VALOR_9  from c000044 where ATB like :ATB AND movimento = 21 and data = :data_caixa),  ' + // sum_9  - cp
      '(select sum(VALOR) VALOR_10 from c000044 where ATB like :ATB AND movimento = 22 and data = :data_caixa),  ' + // sum_10  - cc
      '(select sum(VALOR) VALOR_11 from c000044 where ATB like :ATB AND movimento = 23 and data = :data_caixa),  ' + // sum_11  - cd
    ...
    qrcaixa_mov.SQL.add('select * from c000044 where data = :data_caixa AND ATB LIKE :ATB order by codigo');
  ...
  begin
    ...
    qrcaixa_mov.Close;
    qrcaixa_mov.SQL.clear;
    qrcaixa_mov.SQL.add('select * from c000044 where ATB like :ATB AND data = :data_caixa and codoperador = ''' + FRMMODULO.qrcaixa_operador.FieldByName('codigo').asstring + ''' order by codigo');
    qrcaixa_mov.Params.ParamByName('data_caixa').asdatetime := FRMMODULO.qrcaixa_operador.FieldByName('data').asdatetime;
    qrcaixa_mov.ParamByName('atb').Value := ME_FiltraATB('TB_MOVIMENTO_CAIXA');
    qrcaixa_mov.open;
...
begin
  ...
  begin
    ...
    begin
      Qrsoma.Close;
      Qrsoma.SQL.clear;
      Qrsoma.SQL.add('select sum(entrada) total_entrada, sum(saida) total_saida, ' + '(select sum(VALOR) valor   from c000044 where ATB like :ATB AND movimento = 03 and data = :data_caixa), ' + // sum
        '(select sum(VALOR) valor_1 from c000044 where ATB like :ATB AND movimento = 04 and data = :data_caixa), ' + // sum_1
        '(select sum(VALOR) valor_2 from c000044 where ATB like :ATB AND movimento = 05 and data = :data_caixa), ' + // sum_2
        '(select sum(VALOR) valor_3 from c000044 where ATB like :ATB AND movimento = 06 and data = :data_caixa), ' + // sum_3
        '(select sum(VALOR) valor_4 from c000044 where ATB like :ATB AND movimento = 07 and data = :data_caixa), ' + // sum_4
      ...
      qrcaixa_mov.Close;
      qrcaixa_mov.SQL.clear;
      qrcaixa_mov.SQL.add('select * from c000044 where ATB like :ATB AND data = :data_caixa order by codigo');
      qrcaixa_mov.Params.ParamByName('data_caixa').asdatetime := FRMMODULO.qrcaixa_operador.FieldByName('data').asdatetime;
      qrcaixa_mov.ParamByName('atb').Value := ME_FiltraATB('TB_MOVIMENTO_CAIXA');
      qrcaixa_mov.open;
    ...
    begin
      ...
      Qrsoma.SQL.add('select sum(VALOR) valor_0, ' + // 9 sum_0 dinheiro
        '(select sum(VALOR) valor   from c000044 where ATB like :ATB AND movimento = 10 and data = :data_caixa), ' + // sum 10 cheque a vista
        '(select sum(VALOR) valor_1 from c000044 where ATB like :ATB AND movimento = 11 and data = :data_caixa), ' + // sum_1 11 cheque a prazo
        '(select sum(VALOR) valor_2 from c000044 where ATB like :ATB AND movimento = 12 and data = :data_caixa), ' + // sum_2 12 cartao
        '(select sum(VALOR) valor_3 from c000044 where ATB like :ATB AND movimento = 13 and data = :data_caixa), ' + // sum_3 13 juros
        '(select sum(VALOR) valor_4 from c000044 where ATB like :ATB AND movimento = 14 and data = :data_caixa), ' + // sum_4 14 desconto
        '(select sum(VALOR) valor_5 from c000044 where ATB like :ATB AND movimento = 15 and data = :data_caixa) ' + // sum_5 15 boleto
        'from c000044 where ATB like :ATB AND data = :data_caixa and movimento = 09');
      Qrsoma.Params.ParamByName('data_caixa').asdatetime := FRMMODULO.qrcaixa_operador.FieldByName('data').asdatetime;
      Qrsoma.ParamByName('atb').Value := ME_FiltraATB('TB_MOVIMENTO_CAIXA');
      Qrsoma.open;
      ...
      Qrsoma.SQL.add('select sum(VALOR) valor_0, ' + // sum_0
        '(select sum(VALOR) valor   from c000044 where ATB like :ATB AND movimento = 26 and data = :data_caixa), ' + // sum
        '(select sum(VALOR) valor_1 from c000044 where ATB like :ATB AND movimento = 27 and data = :data_caixa) ' + // sum_1
        'from c000044 where ATB like :ATB AND data = :data_caixa and movimento = 25');
      Qrsoma.Params.ParamByName('data_caixa').asdatetime := FRMMODULO.qrcaixa_operador.FieldByName('data').asdatetime;
      Qrsoma.ParamByName('atb').Value := ME_FiltraATB('TB_MOVIMENTO_CAIXA');
      Qrsoma.open;
      ...
      qrresumo.SQL.add('JOIN c000044 caixa on plano.codigo = caixa.codconta and caixa.data = :datax and plano.tipo = 1');
      qrresumo.SQL.add('WHERE PLANO.ATB LIKE :ATBPLA AND CAIXA.ATB like :ATBCAIXA');
      qrresumo.SQL.add('group by plano.conta, plano.codigo');
      qrresumo.ParamByName('ATBPLA').Value := ME_FiltraATB('TB_PLANO_CONTA');
      qrresumo.ParamByName('ATBCAIXA').Value := ME_FiltraATB('TB_MOVIMENTO_CAIXA');
      ...
      qrresumo.Close;
      qrresumo.SQL.clear;
      qrresumo.SQL.add('select plano.conta, plano.codigo, sum(caixa.valor) total from c000035 plano JOIN c000044 caixa on plano.codigo = caixa.codconta and caixa.data = :datax and plano.tipo = 2');
      qrresumo.SQL.add('WHERE PLANO.ATB LIKE :ATBPLA AND CAIXA.ATB like :ATBCAIXA');
      qrresumo.SQL.add('group by plano.conta, plano.codigo');
      qrresumo.Params.ParamByName('datax').asdatetime := FRMMODULO.qrcaixa_operador.FieldByName('data').asdatetime;
      qrresumo.ParamByName('ATBPLA').Value := ME_FiltraATB('TB_PLANO_CONTA');
    ...
    begin // C A I X A    I N D I V I D U A L
      ...
      Qrsoma.SQL.clear;
      Qrsoma.SQL.add('select sum(VALOR) valor_0, ' + // sum_0
        '(select sum(VALOR) valor   from c000044 where ATB like :ATB AND movimento = 10 and data = :data_caixa and data = :data_caixa and codoperador = ''' + FRMMODULO.qrcaixa_operador.FieldByName('codigo').asstring + '''), ' + '(select sum(VALOR) valor_1 from c000044 where ATB like :ATB AND movimento = 11 and data = :data_caixa and data = :data_caixa and codoperador = ''' + FRMMODULO.qrcaixa_operador.FieldByName('codigo').asstring + '''), ' +
        '(select sum(VALOR) valor_2 from c000044 where ATB like :ATB AND movimento = 12 and data = :data_caixa and data = :data_caixa and codoperador = ''' + FRMMODULO.qrcaixa_operador.FieldByName('codigo').asstring + '''), ' + '(select sum(VALOR) valor_3 from c000044 where ATB like :ATB AND movimento = 13 and data = :data_caixa and data = :data_caixa and codoperador = ''' + FRMMODULO.qrcaixa_operador.FieldByName('codigo').asstring + '''), ' +
        '(select sum(VALOR) valor_4 from c000044 where ATB like :ATB AND movimento = 14 and data = :data_caixa and data = :data_caixa and codoperador = ''' + FRMMODULO.qrcaixa_operador.FieldByName('codigo').asstring + '''), ' + '(select sum(VALOR) valor_5 from c000044 where ATB like :ATB AND movimento = 15 and data = :data_caixa and data = :data_caixa and codoperador = ''' + FRMMODULO.qrcaixa_operador.FieldByName('codigo').asstring + ''') ' + 'from c000044 where ATB like :ATB AND data = :data_caixa and movimento = 09 and data = :data_caixa and codoperador = ''' + FRMMODULO.qrcaixa_operador.FieldByName('codigo').asstring + '''');
      Qrsoma.Params.ParamByName('data_caixa').asdatetime := FRMMODULO.qrcaixa_operador.FieldByName('data').asdatetime;
      Qrsoma.ParamByName('ATB').Value := ME_FiltraATB('TB_MOVIMENTO_CAIXA');
      Qrsoma.open;
      rrec_dinheiro.value := Qrsoma.FieldByName('valor_0').asfloat;
      ...
      Qrsoma.SQL.clear;
      Qrsoma.SQL.add('select sum(VALOR) valor_0, ' + // sum_0
        '(select sum(VALOR) valor   from c000044 where ATB like :ATB AND movimento = 26 and data = :data_caixa and codoperador = ''' + FRMMODULO.qrcaixa_operador.FieldByName('codigo').asstring + '''), ' + '(select sum(VALOR) valor_1 from c000044 where ATB like :ATB AND movimento = 27 and data = :data_caixa and codoperador = ''' + FRMMODULO.qrcaixa_operador.FieldByName('codigo').asstring + ''') ' + 'from c000044 where ATB like :ATB AND data = :data_caixa and movimento = 25 and codoperador = ''' + FRMMODULO.qrcaixa_operador.FieldByName('codigo').asstring + '''');
      Qrsoma.Params.ParamByName('data_caixa').asdatetime := FRMMODULO.qrcaixa_operador.FieldByName('data').asdatetime;
      Qrsoma.ParamByName('ATB').Value := ME_FiltraATB('TB_MOVIMENTO_CAIXA');
      Qrsoma.open;
      RPAG_DINHEIRO.value := Qrsoma.FieldByName('valor_0').asfloat;
      ...
      qrresumo.Close;
      qrresumo.SQL.clear;
      qrresumo.SQL.add('select plano.conta, plano.codigo, sum(caixa.valor) total from c000035 plano JOIN c000044 caixa on plano.codigo = caixa.codconta  and caixa.codoperador = ''' + FRMMODULO.qrcaixa_operador.FieldByName('codigo').asstring + ''' and caixa.data = :datax and plano.tipo = 1');
      qrresumo.SQL.add('WHERE PLANO.ATB LIKE :ATBPLA AND CAIXA.ATB like :ATBCAIXA');
      qrresumo.SQL.add('group by plano.conta, plano.codigo');
      qrresumo.Params.ParamByName('datax').asdatetime := FRMMODULO.qrcaixa_operador.FieldByName('data').asdatetime;
      qrresumo.ParamByName('ATBPLA').Value := ME_FiltraATB('TB_PLANO_CONTA');
  ...
  begin
    ...
    begin
      ...
      begin
        qrmov.Close;
        qrmov.SQL.clear;
        qrmov.SQL.add('delete from c000044 where data = :datax and historico like ''**RETIRADA**%'' and codoperador = ' + QuotedStr(Caixa_Geral));
...
begin
  ...
  begin
    ...
    Qrsoma.ParamByName('atb').Value := ME_GravaATB('TB_FECHAMENTO_CEGO');
    Qrsoma.Open;
    if (Qrsoma.RecordCount = 0) then
    begin
    ...
    else if (Qrsoma.FieldByName('verificado').AsString <> 'S') then
    begin
    ...
    begin
      ...
      Qrsoma.Close;
      Qrsoma.SQL.clear;
      Qrsoma.SQL.add('update FECHAMENTO_CEGO set conciliado = ' + QuotedStr('S') + ' where ATB like :ATB AND data = :Data and operador = :operador and conciliado = ' + QuotedStr('N') + ' and VERIFICADO = ' + QuotedStr('S'));
      Qrsoma.ParamByName('Data').AsDateTime := FRMMODULO.qrcaixa_operador.FieldByName('data').asdatetime;
      Qrsoma.ParamByName('operador').AsInteger := FRMMODULO.qrcaixa_operador.FieldByName('codigo').AsInteger;
      Qrsoma.ParamByName('atb').Value := ME_GravaATB('TB_FECHAMENTO_CEGO');
      Qrsoma.ExecSQL;
