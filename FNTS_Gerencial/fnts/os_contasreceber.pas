    ...
    begin
      ...
      begin
        ...
        begin
          ...
          valor := frmOS_fechamento.rCREDIARIO.Value * (frmmodulo.qrcondpgto_parcela.fieldbyname('percentual').asfloat / 100);
...
procedure Tfrmos_contasreceber.combocondpgtoKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
...
procedure Tfrmos_contasreceber.wwDBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    BGRAVAR.SETFOCUS;
end;
...
procedure Tfrmos_contasreceber.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := CAFREE;
end;
...
procedure Tfrmos_contasreceber.rqtdeKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    perform(wm_nextdlgctl, 0, 0);
end;
