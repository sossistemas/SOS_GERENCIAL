object frmConversaoUnidade: TfrmConversaoUnidade
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'frmConversaoUnidade'
  ClientHeight = 401
  ClientWidth = 577
  Color = clBtnFace
  ...
  object AdvSmoothExpanderPanel1: TAdvSmoothExpanderPanel
    ...
    TabOrder = 0
    ShowExpander = False
    ExpanderColor = 5460819
    ExpanderDownColor = 5460819
    ExpanderHoverColor = 5460819
    TMSStyle = 0
    ...
    object Label53: TLabel
      ...
      Width = 332
      Height = 23
      Caption = 'Produtos - Convers'#227'o de Unidades'
    ...
    Columns = <
      ...
      item
        ...
        PickList.Strings = (
          'Multiplicar'
          'Divis'#227'o')
        Title.Caption = 'Tipo Convers'#227'o'
        Width = 169
        Visible = True
      end
      item
  ...
  object dsConversao: TDataSource
    DataSet = qrConversao
    OnStateChange = dsConversaoStateChange
    Left = 344
    Top = 200
  end
  object qrConversao: TZQuery
    Connection = frmmodulo.Conexao
    BeforeOpen = qrConversaoBeforeOpen
    BeforePost = qrConversaoBeforePost
    AfterPost = qrConversaoAfterPost
    AfterDelete = qrConversaoAfterDelete
    OnNewRecord = qrConversaoNewRecord
    SQL.Strings = (
      'select '
      '  uni.*,'
      '  case uni.Tipo'
      ...
      '  end dFator'
      'from'
      '  conversao_unidade uni '
      'where atb like :atb and uni.codproduto = :cod')
    Params = <
      item
        DataType = ftUnknown
        Name = 'atb'
