object frmIcmsUF: TfrmIcmsUF
  ...
  object qricms: TZQuery
    Connection = frmmodulo.Conexao
    AfterApplyUpdates = qricmsAfterApplyUpdates
    AfterPost = qricmsAfterPost
    SQL.Strings = (
      'select * from icms_uf'
      'order by UF')
    Params = <>
    Left = 40
    Top = 168
    object qricmsUF: TWideStringField
      FieldName = 'UF'
      Required = True
      Size = 2
    end
    object qricmsICMS: TFloatField
      FieldName = 'ICMS'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
