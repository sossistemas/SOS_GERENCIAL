...
begin
  ...
  begin
    ...
    begin
      ...
      if Application.MessageBox(pchar('Deseja Atualizar os Produtos do Grupo Remarcação ' + frmmodulo.qrproduto.fieldbyname('codmarca').asstring + ' ?'), 'Atenção', mb_yesno + MB_ICONWARNING) = idyes then
      begin
