...
begin
  ...
  try
    ...
    begin
      ...
      begin
        CopyFile(PWideChar(sTEFKonekPath + 'IntPos.001'), PWideChar(sTEFPath + 'RESP\IntPos.001'), false);
      end;
...
begin
  ...
  try
    ...
    copyfile(PWideChar(sTEFPath + 'RESP\IntPos.001'), PWideChar(sTEFKoneKPath + 'IntPos.001'), false);
    ...
    begin
      ...
      begin
        ...
        begin
          texto_msg := PWideChar(sDoctoRet + #13#10 +
            sValorRet + #13#10 +
            sRedeRet + #13#10 +
            sTEFMensOperador);
          application.messagebox(texto_msg, 'Atenção', mb_ok + mb_iconWarning);
    ...
    begin
      ...
      begin
        if sValor <> '' then
          ...
          sTextoValor := '';
        texto_msg := PWideChar('Cancelada a transação:' + #13 + #10 +
  ...
  try
    ...
    begin
      try
        ...
        begin
       //   iRet := WinExec(PWideChar('C:\TEF_DISC\TEF_DISC.EXE'), SW_HIDE);
