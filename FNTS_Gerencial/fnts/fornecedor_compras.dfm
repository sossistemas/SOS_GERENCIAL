object frmfornecedor_compras: Tfrmfornecedor_compras
  ...
  object qrcompras: TZQuery
    ...
    object qrcomprasFATOR: TFloatField
      FieldName = 'FATOR'
    end
    object qrcomprasTIPOFATOR: TWideStringField
      FieldName = 'TIPOFATOR'
      Size = 1
    end
    ...
    object qrcomprasCFOP_CAD: TWideStringField
      FieldName = 'CFOP_CAD'
      Size = 4
    end
    object qrcomprasVBCSTRET: TFloatField
      FieldName = 'VBCSTRET'
    end
    object qrcomprasPST: TFloatField
      FieldName = 'PST'
    end
    object qrcomprasVICMSSTRET: TFloatField
      FieldName = 'VICMSSTRET'
    end
    object qrcomprasPREDBCEFET: TFloatField
      FieldName = 'PREDBCEFET'
    end
    object qrcomprasVBCEFET: TFloatField
      FieldName = 'VBCEFET'
    end
    object qrcomprasPICMSEFET: TFloatField
      FieldName = 'PICMSEFET'
    end
    object qrcomprasVICMSEFET: TFloatField
      FieldName = 'VICMSEFET'
    end
    object qrcomprasQTDVENDIDO: TFloatField
      FieldName = 'QTDVENDIDO'
    end
    object qrcomprasID_CONVERSOR_UNIDADE: TIntegerField
      FieldName = 'ID_CONVERSOR_UNIDADE'
    end
    object qrcomprasDESCRICAO_FATOR: TWideStringField
      FieldName = 'DESCRICAO_FATOR'
      Size = 50
    end
    object qrcomprasID_CONVERSAO_UNIDADE: TIntegerField
      FieldName = 'ID_CONVERSAO_UNIDADE'
    end
    object qrcomprasATB: TWideStringField
      FieldName = 'ATB'
      Size = 30
    end
    ...
    object qrcomprasCSOSN_1: TWideStringField
      FieldName = 'CSOSN_1'
      Size = 60
    end
    ...
    object qrcomprasORIGEM: TIntegerField
      FieldName = 'ORIGEM'
    end
    object qrcomprasIND_CFOP_NFCE: TWideStringField
      FieldName = 'IND_CFOP_NFCE'
      Size = 4
    end
    object qrcomprasFOTOBD: TBlobField
      FieldName = 'FOTOBD'
    end
    object qrcomprasID_TIPO_SERVICO: TIntegerField
      FieldName = 'ID_TIPO_SERVICO'
    end
    object qrcomprasNAO_MOVIMENTA_ESTOQUE: TWideStringField
      FieldName = 'NAO_MOVIMENTA_ESTOQUE'
      Size = 1
    end
    object qrcomprasPESAGEM_AUOTMATICA: TWideStringField
      FieldName = 'PESAGEM_AUOTMATICA'
      Size = 1
    end
    object qrcomprasINFORMA_CODIGO_BARRA_XML: TWideStringField
      FieldName = 'INFORMA_CODIGO_BARRA_XML'
      Size = 1
    end
    object qrcomprasCODIGO_ANP: TWideStringField
      FieldName = 'CODIGO_ANP'
      Size = 10
    end
    object qrcomprasCOMBO: TWideStringField
      FieldName = 'COMBO'
      Size = 1
    end
    object qrcomprasIND_CFOP_DEV_COMPRA_DENTRO: TWideStringField
      FieldName = 'IND_CFOP_DEV_COMPRA_DENTRO'
      Size = 6
    end
    object qrcomprasIND_CFOP_DEV_COMPRA_FORA: TWideStringField
      FieldName = 'IND_CFOP_DEV_COMPRA_FORA'
      Size = 6
    end
    object qrcomprasPIZZA: TWideStringField
      FieldName = 'PIZZA'
      Size = 1
    end
    object qrcomprasPERCGLNN: TFloatField
      FieldName = 'PERCGLNN'
    end
    object qrcomprasPERCGLGNI: TFloatField
      FieldName = 'PERCGLGNI'
    end
    object qrcomprasPGLP: TFloatField
      FieldName = 'PGLP'
    end
    object qrcomprasVPART: TFloatField
      FieldName = 'VPART'
    end
    object qrcomprasECF_ICMS: TWideStringField
      FieldName = 'ECF_ICMS'
      Size = 30
    end
    object qrcomprasIDONLINE: TIntegerField
      FieldName = 'IDONLINE'
    end
    object qrcomprasEMDESTAQUE: TWideStringField
      FieldName = 'EMDESTAQUE'
      Size = 1
    end
    object qrcomprasDESCONTOMAXIMO: TFloatField
      FieldName = 'DESCONTOMAXIMO'
    end
    object qrcomprasATB_1: TWideStringField
      FieldName = 'ATB_1'
      Size = 30
    end
  end
