object frmos_servicosperiodicos: Tfrmos_servicosperiodicos
  Left = 121
  Top = 181
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Ordem de Servi'#231'os | Manuten'#231#227'o Periodica'
  ClientHeight = 390
  ClientWidth = 776
  Color = clBtnFace
  ...
  object GRID5: TwwDBGrid
    ...
    Selected.Strings = (
      'STATUS'#9'2'#9'ST'#9'F'
      'CODSERVICO'#9'6'#9'C'#211'D'#9'F'
      'servico'#9'23'#9'Servi'#231'o'#9'F'
      'MARCA'#9'21'#9'Marca'#9'F'#9'Equipamento'
      'MODELO'#9'16'#9'Modelo'#9'F'#9'Equipamento'
      'SERIE'#9'17'#9'N'#186' de S'#233'rie'#9'F'#9'Equipamento'
      'PRIMEIRA_MANUTENCAO'#9'10'#9'Primeira'#9'F'#9'Manuten'#231#227'o'
      'ULTIMA_MANUTENCAO'#9'10'#9#218'ltima'#9'F'#9'Manuten'#231#227'o'
      'proxima_manutencao'#9'10'#9'Pr'#243'xima'#9'F'#9'Manuten'#231#227'o')
  ...
  object ImageList1: TImageList
    ...
    Top = 129
    Bitmap = {
      494C010171007500080010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
