...
uses
  ...
  Dialogs, Wwkeycb, StdCtrls, ExtCtrls, Collection, Mask, Buttons, Menus, DB,
  Grids, Wwdbigrd, Wwdbgrid, TFlatPanelUnit, AdvGlowButton, ZAbstractRODataset,
  ZDataset, JvExMask, JvToolEdit, JvBaseEdits, ZAbstractDataset;
...
type
  Tfrmvenda_troca = class(TForm)
    ...
    procedure eproduto2KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
...
uses
  principal, modulo, venda, venda_grade, venda_serial;
...
begin
  ...
  begin
    application.messagebox('Favor informar o produto de Entrada!', 'Atenção!', mb_ok + MB_ICONWARNING);
    ecodigo.setfocus;
    exit;
  end;
  if ecodigo2.text = '' then
  begin
    application.messagebox('Favor informar o produto da Saída!', 'Atenção!', mb_ok + MB_ICONWARNING);
    ecodigo2.setfocus;
    exit;
  end;
  ...
  begin
    application.messagebox('Produto de ENTRADA não encontrado!', 'Atenção!', mb_ok + MB_ICONWARNING);
    exit;
  end;
  ...
  begin
    ...
    frmvenda.qrproduto_serial.sql.Add('select * from c000022 where atb like :atb and codproduto = ''' + frmmodulo.qrproduto.fieldbyname('codigo').asstring + ''' and codcliente = ''' + frmvenda.lcliente_codigo.Caption + ''' and situacao = 2 and serial = ''' + lserial.Caption + '''');
    ...
    begin
      application.messagebox('Serial de ENTRADA não encontrado!', 'Atenção!', mb_ok + MB_ICONWARNING);
      exit;
    end;
  ...
  begin
    ...
    frmvenda.qrproduto_grade.sql.Add('select * from c000021 where atb like :atb and codigo = ''' + codigo_serial_grade + '''');
    ...
    begin
      application.messagebox('Grade de ENTRADA não encontrada!', 'Atenção!', mb_ok + MB_ICONWARNING);
      exit;
    end;
...
///////////////////////////////////////////////////////////////////
  ...
  begin
    application.messagebox('Produto de SAÍDA não encontrado!', 'Atenção!', mb_ok + MB_ICONWARNING);
    exit;
  end;
  ...
  begin
    ...
    frmvenda.qrproduto_serial.close;
    frmvenda.qrproduto_serial.sql.clear;
    frmvenda.qrproduto_serial.sql.Add('select * from c000022 where atb like :atb and codproduto = ''' + frmmodulo.qrproduto.fieldbyname('codigo').asstring + ''' and situacao = 1 and serial = ''' + lserial2.Caption + '''');
    frmvenda.qrproduto_serial.ParamByName('atb').Value := ME_FiltraATB('TB_SERIAL_PRODUTO');
    frmvenda.qrproduto_serial.open;

    if frmvenda.qrproduto_serial.recordcount = 0 then
    begin
      application.messagebox('Serial de SAÍDA não encontrado!', 'Atenção!', mb_ok + MB_ICONWARNING);
      exit;
    end;
  ...
  begin
    ...
    frmvenda.qrproduto_grade.close;
    frmvenda.qrproduto_grade.sql.clear;
    frmvenda.qrproduto_grade.sql.Add('select * from c000021 where atb like :atb and codigo = ''' + codigo_serial_grade2 + '''');
    frmvenda.qrproduto_grade.ParamByName('atb').Value := ME_FiltraATB('TB_GRADE_PRODUTO');
    frmvenda.qrproduto_grade.open;

    if frmvenda.qrproduto_grade.recordcount = 0 then
    begin
      application.messagebox('Grade de SAÍDA não encontrada!', 'Atenção!', mb_ok + MB_ICONWARNING);
      exit;
    end;
    ...
    begin
      ...
      begin
        ...
        begin
          frmvenda.qrproduto_grade.close;
          frmvenda.qrproduto_grade.sql.clear;
          frmvenda.qrproduto_grade.sql.Add('select * from c000021 where atb like :atb and codproduto = ''' + frmmodulo.qrproduto.fieldbyname('codigo').asstring + ''' order by codigo');
          frmvenda.qrproduto_grade.ParamByName('atb').Value := ME_FiltraATB('TB_GRADE_PRODUTO');
          frmvenda.qrproduto_grade.open;
        ...
        begin
          ...
          begin
            frmvenda.qrproduto_serial.close;
            frmvenda.qrproduto_serial.sql.clear;
            frmvenda.qrproduto_serial.sql.Add('select * from c000022 where atb like :atb and codproduto = ''' + frmmodulo.qrproduto.fieldbyname('codigo').asstring + ''' and codcliente = ''' + frmvenda.lcliente_codigo.Caption + ''' and situacao = 2 and serial = ''' + InputBox('TROCA - Produto', 'Informe o serial do Produto:', '') + '''');
            frmvenda.qrproduto_serial.ParamByName('atb').Value := ME_FiltraATB('TB_SERIAL_PRODUTO');
            frmvenda.qrproduto_serial.open;
...
procedure Tfrmvenda_troca.EPRODUTOKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = vk_down then
  begin
...
procedure Tfrmvenda_troca.wwDBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #27 then
    EPRODUTO.SetFocus;
  if Key = #13 then
...
procedure Tfrmvenda_troca.runitarioKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    ecodigo2.SetFocus;
end;
...
procedure Tfrmvenda_troca.wwDBGrid2KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #27 then
    EPRODUTO2.SetFocus;
  if Key = #13 then
      ...
      begin
        ...
        begin
          ...
          if estoque_negativo then
            ...
            frmvenda.qrproduto_grade.sql.Add('select * from c000021 where atb like :atb and codproduto = ''' + frmmodulo.qrproduto.fieldbyname('codigo').asstring + ''' and estoque > 0 order by codigo');
          frmvenda.qrproduto_grade.ParamByName('atb').Value := ME_FiltraATB('TB_GRADE_PRODUTO');
          frmvenda.qrproduto_grade.open;
        ...
        begin
          ...
          begin
            frmvenda.qrproduto_serial.close;
            frmvenda.qrproduto_serial.sql.clear;
            frmvenda.qrproduto_serial.sql.Add('select * from c000022 where atb like :atb and codproduto = ''' + frmmodulo.qrproduto.fieldbyname('codigo').asstring + ''' and situacao = 1 order by codigo');
            frmvenda.qrproduto_serial.ParamByName('atb').Value := ME_FiltraATB('TB_SERIAL_PRODUTO');
            frmvenda.qrproduto_serial.open;
...
procedure Tfrmvenda_troca.eproduto2KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = vk_down then
  begin
...
procedure Tfrmvenda_troca.eproduto2KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    if eproduto2.TEXT <> '' then
...
procedure Tfrmvenda_troca.runitario2KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    bgravar.setfocus;
end;
