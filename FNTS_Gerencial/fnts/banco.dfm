object frmbanco: Tfrmbanco
  ...
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'BANCOS / INSTITUI'#199#213'ES FINANCEIRAS | Ficha de Cadastro'
  ClientHeight = 460
  ClientWidth = 804
  Color = clWhite
  ...
  object pficha: TFlatPanel
    ...
    object blocregiao: TAdvGlowButton
      Left = 6
      Top = 87
      Width = 31
      Height = 29
    ...
    object GroupBox1: TGroupBox
      ...
      object DBCheckBox2: TDBCheckBox
        ...
        Width = 207
        Height = 17
        Caption = 'Administradora de Cart'#245'es de Cr'#233'dito'
    ...
    object rgrupo: TwwRadioGroup
      ...
      DisableThemes = False
      Transparent = True
      Caption = 'Ressarcimento de Vendas'
      Color = clSilver
      DataField = 'RESSARCIMENTO'
      DataSource = dsbanco2
      Items.Strings = (
        'por Data Base'
        'por prazo (dias)')
    ...
    object GroupBox2: TGroupBox
      ...
      object Label3: TLabel
        ...
        Width = 149
        Height = 13
        Caption = 'Venda no Cart'#227'o de D'#233'bito -->'
      end
      object Label4: TLabel
        ...
        Width = 153
        Height = 13
        Caption = 'Venda no Cart'#227'o de Cr'#233'dito -->'
      end
      ...
      object Label12: TLabel
        ...
        Height = 13
        Alignment = taRightJustify
        Caption = 'CNPJ Administradora de Cart'#227'o'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object Label13: TLabel
        ...
        Height = 13
        Alignment = taRightJustify
        Caption = 'C'#243'digo Administradora de Cart'#227'o para SAT'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object Label14: TLabel
        ...
        Height = 13
        Caption = 
          'Anexo 3 '#8211' Tabela de credenciadoras de cart'#227'o de d'#233'bito ou cr'#233'dit' +
          'o no Manual do SAT'
      end
      object ed_dias_debito: TRzDBSpinEdit
        Left = 368
        Top = 27
        Width = 52
        Height = 21
        DataSource = dsbanco2
        DataField = 'REC_DEBITO'
        Alignment = taRightJustify
        Color = 15916445
        FocusColor = 10550008
        MaxLength = 999
      ...
      object ed_dias_credito: TRzDBSpinEdit
        Left = 368
        Top = 54
        Width = 52
        Height = 21
      ...
      object ed_credito: TcxDBTextEdit
        Left = 231
        Top = 54
        DataBinding.DataField = 'COMISSAO_CREDITO'
      ...
      object ed_debito: TcxDBTextEdit
        Left = 231
        Top = 27
        DataBinding.DataField = 'COMISSAO_DEBITO'
        DataBinding.DataSource = dsbanco2
        Style.BorderStyle = ebs3D
        Style.Color = 15916445
        Style.Edges = [bLeft, bTop, bRight, bBottom]
    ...
    object GroupBox3: TGroupBox
      ...
      object Label15: TLabel
        ...
        Width = 146
        Height = 13
        Caption = 'Caminho das logos dos bancos'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object Label17: TLabel
        ...
        Width = 116
        Height = 13
        Caption = 'Tamanho Nosso N'#250'mero'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object cxDBSpinEdit1: TcxDBSpinEdit
        Left = 143
        Top = 70
        DataBinding.DataField = 'TAMANHO_NOSSO_NUMERO'
        DataBinding.DataSource = dsbanco2
