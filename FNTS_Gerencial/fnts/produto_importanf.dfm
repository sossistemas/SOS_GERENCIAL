object frmproduto_importanf: Tfrmproduto_importanf
  Left = 474
  Top = 163
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'NOTA FISCAL | Importar'
  ClientHeight = 358
  ClientWidth = 599
  Color = clBtnFace
  ...
  object GRID: TwwDBGrid
    ...
    Height = 227
    Selected.Strings = (
      'DATA_LANCAMENTO'#9'10'#9'Data Lancto.'
      'NUMERO'#9'8'#9'Nota Fiscal'
      'fornecedor'#9'55'#9'Emitente'
      'CFOP'#9'5'#9'CFOP'
      'CONF_TOTALNOTA'#9'11'#9'Total')
