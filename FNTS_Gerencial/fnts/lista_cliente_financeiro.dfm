object frmlista_cliente_financeiro: Tfrmlista_cliente_financeiro
  Left = 302
  Top = 427
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'CLIENTES - FINANCEIRO | Relat'#243'rios'
  ClientHeight = 174
  ClientWidth = 528
  Color = 11429670
  ...
  object pnl1: TPanel
    ...
    object combo_relatorio: TComboBox
      ...
      Items.Strings = (
        ...
        'CARTA DE COBRAN'#199'A - 1a. Cobran'#231'a'
        'CARTA DE COBRAN'#199'A - 2a. Cobran'#231'a'
        'CARTA DE COBRAN'#199'A - Registro SPC/SERASA'
        'RESUMO POR CLIENTE'
        'COMPRAS')
    end
  end
  object AdvSmoothExpanderPanel1: TAdvSmoothExpanderPanel
    ...
    object Label53: TLabel
      ...
      Width = 305
      Height = 23
      Caption = 'Relat'#243'rio Financeiro de Clientes'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -19
      Font.Name = 'Verdana'
  ...
  object fxcliente: TfrxReport
    ...
    ReportOptions.CreateDate = 39185.730673645800000000
    ReportOptions.LastChange = 39576.749111145800000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo4: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fscliente_inativo."DATA_ULTIMACOMPRA"]')
          ParentFont = False
        end
      end
  ...
  object qrcontasreceber: TZQuery
    ...
    object qrcontasrecebercliente_endereco: TStringField
      FieldKind = fkLookup
    ...
    object qrcontasrecebercliente_bairro: TStringField
      FieldKind = fkLookup
    ...
    object qrcontasrecebercliente_cidade: TStringField
      FieldKind = fkLookup
    ...
    object qrcontasrecebercliente_uf: TStringField
      FieldKind = fkLookup
    ...
    object qrcontasrecebercliente_cep: TStringField
      FieldKind = fkLookup
    ...
    object qrcontasrecebercliente_telefone: TStringField
      FieldKind = fkLookup
    ...
    object qrcontasrecebercliente_celular: TStringField
      FieldKind = fkLookup
    ...
    object qrcontasrecebercliente_ref: TStringField
      FieldKind = fkLookup
      FieldName = 'cliente_ref'
      LookupDataSet = frmmodulo.qrcliente
      LookupKeyFields = 'codigo'
