...
uses
  ...
  Wwdbigrd, Wwdbgrid, ZAbstractRODataset, ZDataset, ZAbstractDataset;
...
procedure Tfrmloc_caixa.qrcaixa_operadorBeforeOpen(DataSet: TDataSet);
begin
  qrcaixa_operador.ParamByName('atbcx').Value := ME_FiltraATB('TB_CAIXA');
  qrcaixa_operador.ParamByName('atbfnc').Value := ME_FiltraATB('TB_FUNCIONARIO');
end;
