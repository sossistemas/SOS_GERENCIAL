object frmlista_transportador2: Tfrmlista_transportador2
  Left = 378
  Top = 321
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'TRANSPORTADORES | Relat'#243'rios'
  ClientHeight = 230
  ClientWidth = 519
  Color = 11429670
  ...
  object pnl1: TPanel
    ...
    object combo_transportador: TComboBox
      Left = 104
      Top = 78
      Width = 281
      Height = 21
      ...
      Color = 15916445
      TabOrder = 1
      OnChange = combo_transportadorChange
      Items.Strings = (
        'TODOS'
        'SELECIONAR')
    end
  ...
  object fxtransportador: TfrxReport
    Version = '5.3.16'
    ...
    ReportOptions.LastChange = 39202.399883344900000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo14: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fstransportador."TELEFONE"]  [fstransportador."CELULAR"]')
          ParentFont = False
        end
        object Memo4: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fstransportador."PLACA"]/[fstransportador."UFPLACA"]')
          ParentFont = False
        end
      end
  ...
  object fstransportador: TfrxDBDataset
