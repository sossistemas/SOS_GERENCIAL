object frmProduto_serial_ficha: TfrmProduto_serial_ficha
  Left = 369
  Top = 214
  BorderIcons = []
  ...
  object Panel1: TPanel
    ...
    object ed_cod_fornecedor: TRzButtonEdit
      Left = 80
      Top = 32
      Width = 65
      Height = 21
      ...
      AltBtnWidth = 15
      ButtonWidth = 15
      OnButtonClick = ed_cod_fornecedorButtonClick
    end
    object ed_fornecedor: TEdit
      Left = 152
      Top = 32
      Width = 193
      Height = 21
    ...
    object ed_preco: TRzNumericEdit
      Left = 88
      Top = 56
      Width = 89
      Height = 21
      TabOrder = 4
      OnKeyPress = ed_precoKeyPress
      IntegersOnly = False
      DisplayFormat = '###,###,##0.00'
    end
  end
  ...
  object qrserial: TClientDataSet
    PersistDataPacket.Data = {
      350000009619E0BD010000001800000001000000000003000000350006736572
      69616C01004900000001000557494454480200020032000000}
    Active = True
    Aggregates = <>
    Params = <>
    Left = 88
    Top = 128
    object qrserialserial: TStringField
      DisplayWidth = 50
      FieldName = 'serial'
      Size = 50
    end
