...
uses
  ...
  Dialogs, StdCtrls, Mask, Buttons, DB, Menus, AdvGlowButton, ExtCtrls,
  TFlatPanelUnit, AdvMetroButton, AdvSmoothExpanderPanel,
  JvExMask, JvToolEdit, JvBaseEdits, JvDBControls, AdvSmoothPanel;
...
procedure Tfrmcontasreceber_juros.RxDBCalcEdit1KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
...
procedure Tfrmcontasreceber_juros.RxDBCalcEdit3KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    bitbtn1.setfocus;
end;
