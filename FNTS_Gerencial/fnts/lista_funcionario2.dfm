object frmlista_funcionario2: Tfrmlista_funcionario2
  ...
  object qrfuncionario: TZQuery
    ...
    Left = 168
    Top = 264
    object qrfuncionarioCODIGO: TWideStringField
      FieldName = 'CODIGO'
      Required = True
      Size = 6
    end
    ...
    object qrfuncionarioENDERECO: TWideStringField
      FieldName = 'ENDERECO'
      Size = 80
    end
    object qrfuncionarioBAIRRO: TWideStringField
      FieldName = 'BAIRRO'
      Size = 30
    end
    object qrfuncionarioCIDADE: TWideStringField
      FieldName = 'CIDADE'
      Size = 40
    end
    object qrfuncionarioUF: TWideStringField
      FieldName = 'UF'
      Size = 2
    end
    object qrfuncionarioCEP: TWideStringField
      FieldName = 'CEP'
      Size = 10
    end
    object qrfuncionarioTELEFONE: TWideStringField
      FieldName = 'TELEFONE'
    end
    object qrfuncionarioCELULAR: TWideStringField
      FieldName = 'CELULAR'
    end
    object qrfuncionarioEMAIL: TWideStringField
      FieldName = 'EMAIL'
      Size = 50
    end
    object qrfuncionarioCPF: TWideStringField
      FieldName = 'CPF'
      Size = 15
    end
    object qrfuncionarioRG: TWideStringField
      FieldName = 'RG'
      Size = 25
    end
    object qrfuncionarioCTPS: TWideStringField
      FieldName = 'CTPS'
      Size = 25
    end
    object qrfuncionarioFUNCAO: TWideStringField
      FieldName = 'FUNCAO'
      Size = 30
    end
    object dtfldDATA_ADMISSAO: TDateField
      FieldName = 'DATA_ADMISSAO'
    end
    object dtfldDATA_DEMISSAO: TDateField
    ...
    object qrfuncionarioOBS1: TWideStringField
      FieldName = 'OBS1'
      Size = 80
    end
    object qrfuncionarioOBS2: TWideStringField
      FieldName = 'OBS2'
      Size = 80
    end
    object qrfuncionarioOBS3: TWideStringField
      FieldName = 'OBS3'
      Size = 80
    end
    object dtfldNASCIMENTO: TDateField
      FieldName = 'NASCIMENTO'
    end
    object qrfuncionarioF_CAIXA: TIntegerField
      FieldName = 'F_CAIXA'
    end
    object qrfuncionarioF_VENDEDOR: TIntegerField
      FieldName = 'F_VENDEDOR'
    end
    object qrfuncionarioF_TECNICO: TIntegerField
      FieldName = 'F_TECNICO'
    end
    object qrfuncionarioNUMERO: TWideStringField
      FieldName = 'NUMERO'
      Size = 10
    end
  end
