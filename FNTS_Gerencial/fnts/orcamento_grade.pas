...
uses
  ...
  AdvGlowButton, Vcl.ExtCtrls, Vcl.Grids, Wwdbigrd, Wwdbgrid, ZAbstractRODataset,
...
procedure Tfrmorcamento_grade.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := cafree;
end;
