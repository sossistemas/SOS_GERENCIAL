...
begin
  ...
  sSql := sSql + ' AND cli.ATB LIKE ' + QuotedStr(ME_FiltraATB('TB_CLIENTE'));
  sSql := sSql + ' AND rec.ATB LIKE ' + QuotedStr(ME_FiltraATB('TB_CONTA_RECEBER'));
  sSql := sSql + ' AND fun.ATB LIKE ' + QuotedStr(ME_FiltraATB('TB_FUNCIONARIO'));
  ...
  frxCartaCobranca.LoadFromFile('\SOS\server\rel\F000212.fr3');
