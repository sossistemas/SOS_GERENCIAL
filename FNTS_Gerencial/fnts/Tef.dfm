object frmTef: TfrmTef
  ...
  object GroupBox1: TGroupBox
    ...
    Caption = 'Bandeira'
    TabOrder = 0
    object check_visa: TRadioButton
      Left = 8
      Top = 16
      Width = 153
      Height = 17
      Caption = '&VisaNet / Redecart / Amex'
      Checked = True
      TabOrder = 0
      TabStop = True
    end
    object check_tecban: TRadioButton
      Left = 8
      Top = 32
      Width = 153
      Height = 17
      Caption = '&TecBan (Banco 24 Hs)'
      TabOrder = 1
    end
  end
  object GroupBox2: TGroupBox
    ...
    object check_cancel: TRadioButton
      Left = 8
      Top = 32
      Width = 153
      Height = 17
