...
uses
  ...
  frxDBSet, frxDesgn, DBClient, ZAbstractRODataset, ZDataset,
...
uses
  modulo, principal, entrega;

{$R *.dfm}

procedure TfrmEntrega_ficha.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
begin
  ...
  begin
    ...
    qrentrega2.sql.add('(CODVENDA,CODPRODUTO,QTDE_ENTREGUE,qtde_vendida,codcliente,data_entrega,data_venda, ATB)');
...
begin
  ...
  begin
    qrEntrega.fieldbyname('qtde_saldo').asfloat := qrEntrega.fieldbyname('qtde_vendida').asfloat - qrEntrega.fieldbyname('qtde_ja_entregue').asfloat - qrEntrega.fieldbyname('qtde_entregue').asfloat;
  end
  else
  begin
    qrEntrega.fieldbyname('qtde_entregue').asfloat := qrEntrega.fieldbyname('qtde_vendida').asfloat - qrEntrega.fieldbyname('qtde_ja_entregue').asfloat;
...
begin
  ...
  begin
    ...
    writeln(arquivo, #27#80 + #18 + #27#71 + #20, frmPrincipal.Texto_Justifica(emitente_fantasia, 12, ' ', 'D') + #27#80 + #15 + #27#72 + #20 + ' ' + frmPrincipal.Texto_Justifica(emitente_telefone, 13, ' ', 'D') + #27#80 + #18 + #27#72 + #20 + ' GUIA DE ENTREGA --> AVULSA     DATA: ' + frmPrincipal.Texto_Justifica(DATETOSTR(date), 10, ' ', 'E') + ' ' + frmPrincipal.Texto_Justifica(timetostr(time), 5, ' ', 'E'));
...
begin
  ...
  begin
    ...
    writeln(arquivo, #15 + #27#72 + #20, 'GUIA DE ENTREGA - AVULSA' + '  Emis: ' + frmPrincipal.Texto_Justifica(DATETOSTR(date), 10, ' ', 'E') + ' ' + frmPrincipal.Texto_Justifica(timetostr(time), 5, ' ', 'E'));
    writeln(arquivo, #15 + #27#72 + #20, '----------------------------------------------------');
...
begin
  ...
  frmmodulo.qrrelatorio.fieldbyname('linha9').asstring := Caixa_Geral;
