object frmlista_servicos_periodicos: Tfrmlista_servicos_periodicos
  Left = 508
  Top = 431
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'CLIENTES - SERVI'#199'OS PERI'#211'DICOS | Relat'#243'rios'
  ClientHeight = 170
  ClientWidth = 505
  Color = clSilver
  ...
  object combo_cliente: TComboBox
    ...
    OnKeyPress = combo_clienteKeyPress
    Items.Strings = (
      'TODOS'
      'SELECIONAR')
  end
  ...
  object AdvSmoothExpanderPanel1: TAdvSmoothExpanderPanel
    ...
    object Label53: TLabel
      ...
      Width = 309
      Height = 23
      Caption = 'Relat'#243'rio de Servi'#231'os Peri'#243'dicos'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -19
      Font.Name = 'Verdana'
  ...
  object fxservicos_periodicos: TfrxReport
    Version = '5.3.16'
    ...
    ReportOptions.LastChange = 39499.530073958300000000
    ...
    Datasets = <
      item
        DataSet = fsservicos_periodicos
        DataSetName = 'fsservicos_periodicos'
      end
      item
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo12: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fsservicos_periodicos."CODSERVICO"]')
          ParentFont = False
        end
        object Memo13: TfrxMemoView
          Left = 299.448980000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fsservicos_periodicos."MARCA"]')
          ParentFont = False
        end
        object Memo14: TfrxMemoView
          Left = 671.842920000000000000
          Top = 1.000000000000000000
          Width = 64.252010000000000000
          Height = 15.118120000000000000
          DataField = 'proxima_manutencao'
          DataSet = fsservicos_periodicos
          DataSetName = 'fsservicos_periodicos'
          DisplayFormat.DecimalSeparator = ','
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fsservicos_periodicos."proxima_manutencao"]')
          ParentFont = False
        end
        object Memo29: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fsservicos_periodicos."MODELO"]')
          ParentFont = False
        end
        object Memo30: TfrxMemoView
          Left = 494.102660000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fsservicos_periodicos."SERIE"]')
          ParentFont = False
        end
        object Memo31: TfrxMemoView
          Left = 568.693260000000000000
          Width = 71.811070000000000000
          Height = 15.118120000000000000
          DataField = 'ULTIMA_MANUTENCAO'
          DataSet = fsservicos_periodicos
          DataSetName = 'fsservicos_periodicos'
          DisplayFormat.DecimalSeparator = ','
          DisplayFormat.Kind = fkDateTime
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fsservicos_periodicos."ULTIMA_MANUTENCAO"]')
          ParentFont = False
        end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 740.409927000000000000
        Condition = 'fsservicos_periodicos."CODCLIENTE"'
        ...
        object Memo32: TfrxMemoView
          ...
          Font.Style = [fsBold]
          Memo.UTF8W = (
            '[fsservicos_periodicos."CODCLIENTE"]')
          ParentFont = False
        end
  ...
  object fsservicos_periodicos: TfrxDBDataset
    UserName = 'fsservicos_periodicos'
  ...
  object qrservicos_periodicos: TZQuery
    ...
    SQL.Strings = (
        ...
        'select codcliente,codservico,marca,modelo,serie,ultima_manutenca' +
        'o,periodo,max(status) status'
      'from servicos_periodicos'
      
        'group by codcliente,codservico,marca,modelo,serie,ultima_manuten' +
        'cao,periodo')
    Params = <>
    Left = 448
    Top = 266
    object qrservicos_periodicosservico: TStringField
      FieldKind = fkLookup
      FieldName = 'servico'
      LookupDataSet = frmmodulo.qrservico
    ...
    object dtfld_periodicosULTIMA_MANUTENCAO: TDateField
