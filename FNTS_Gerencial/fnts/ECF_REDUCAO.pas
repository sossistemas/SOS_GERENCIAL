...
uses
  ...
  Dialogs, StdCtrls, Mask, ExtCtrls, DB, Wwdatsrc, Buttons, DBCtrls, PageView, Menus, Grids, DBGrids, Wwdotdot, Wwdbcomb,
  ...
  RzCmboBx, RzDBChk, RzDBCmbo, CellEditors, Collection, TFlatPanelUnit, AdvToolBar, AdvOfficeStatusBar,
  ImgList, AdvToolBarStylers, AdvPreviewMenu, AdvPreviewMenuStylers,
  AdvOfficeStatusBarStylers, AdvGlowButton, RzDBNav, System.ImageList, JvExMask,
...
uses Xloc_empresa, Xloc_modelo, Xloc_produto,
  modulo, principal, ecf_cupom, ecf_reducao_menu;
