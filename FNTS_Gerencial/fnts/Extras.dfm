object frmExtras: TfrmExtras
  ...
  object Panel2: TPanel
    ...
    object Label20: TLabel
      ...
      Width = 261
      Height = 23
      Caption = 'Itens Extras para Produtos '
  ...
  object qrExtras: TZQuery
    ...
    BeforeOpen = qrExtrasBeforeOpen
    BeforePost = qrExtrasBeforePost
    AfterPost = qrExtrasAfterPost
    OnNewRecord = qrExtrasNewRecord
    SQL.Strings = (
      'select * from extras WHERE atb like :atb')
    Params = <
      item
        DataType = ftUnknown
        Name = 'atb'
    ...
    object qrExtrasATB: TWideStringField
      FieldName = 'ATB'
      Size = 30
    end
  end
  object dsExtras: TDataSource
    DataSet = qrExtras
    OnStateChange = dsExtrasStateChange
    Left = 288
    Top = 192
  end
  object qrExclui: TZQuery
    Connection = frmmodulo.Conexao
    SQL.Strings = (
      'select count(*) qtd  from c000017 gr where gr.id_impressora = 1')
    Params = <>
    Left = 417
    Top = 129
