...
uses
  ...
  Wwdbigrd, Wwdbgrid, Buttons, Menus, AdvGlowButton, ComCtrls, AdvMetroButton, AdvSmoothPanel, AdvSmoothExpanderPanel;
...
procedure Tfrmloc_marca.AdvMetroButton1Click(Sender: TObject);
begin
 Close;
end;
