...
begin
  ...
  begin
    ...
    begin
      texto := PWideChar('Existe uma marca/fabricante cadastrado com este nome!' + #13 + qrduplo.fieldbyname('codigo').asstring + ' - ' + qrduplo.fieldbyname('nome').asstring + #13 + 'Endereço: ' + qrduplo.fieldbyname('ENDERECO').asSTRING + '!' + #13 + 'Deseja prosseguir?');
