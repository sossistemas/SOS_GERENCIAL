...
uses
  ...
  Buttons, DB, ZAbstractRODataset, ZDataset, frxClass,
...
type
  Tfrmlista_caixa2 = class(TForm)
    ...
    Qrsoma: TZQuery;
    qrresumo: TZQuery;
    qrcaixaCODIGO: TWideStringField;
    qrcaixaCODCAIXA: TWideStringField;
    qrcaixaCODOPERADOR: TWideStringField;
    qrcaixaSAIDA: TFloatField;
    qrcaixaENTRADA: TFloatField;
    qrcaixaCODCONTA: TWideStringField;
    qrcaixaHISTORICO: TWideStringField;
    qrcaixaMOVIMENTO: TIntegerField;
    qrcaixaVALOR: TFloatField;
    qrcaixaCODNFSAIDA: TWideStringField;
    ...
    qrcaixaCODVENDA: TWideStringField;
    qrcaixaSERIAL_POS: TWideStringField;
    qrcaixaCARTAO_NOME_CONSUMIDOR: TWideStringField;
    qrcaixaCARTAO_BIN: TWideStringField;
    qrcaixaCARTAO_VALIDADE: TWideStringField;
    qrcaixaCARTAO_PARCELAS: TIntegerField;
    qrcaixaCARTAO_4DIGITOS: TIntegerField;
    qrcaixaCARTAO_N_AUTORIZACAO: TWideStringField;
    qrcaixaCARTAO_NSU: TWideStringField;
    qrcaixaCARTAO_INSTITUICAO: TWideStringField;
    qrcaixaCARTAO_ID_PAGAMENTO: TWideStringField;
    qrcaixaCHAVE: TWideStringField;
    qrcaixaNUMERO_CFE: TWideStringField;
    qrcaixaCARTAO_BANDEIRA: TWideStringField;
    qrcaixaCARTAO_RF: TWideStringField;
    qrcaixaCARTAO_MENSAGEM: TWideStringField;
    qrcaixaHORA: TWideStringField;
...
uses modulo, loc_caixa, principal,
  loc_conta;
...
begin
  ...
  begin
    ...
    combo_caixa.Items.Add(frmloc_caixa.qrcaixa_operadorCODIGO.asstring + ' ' + frmloc_caixa.qrcaixa_operadorNOME.asstring);
    combo_caixa.ItemIndex := combo_caixa.Items.Count - 1;
    FreeAndNil(frmloc_caixa);
  end;
end;
...
procedure Tfrmlista_caixa2.AdvMetroButton1Click(Sender: TObject);
begin
  close;
end;
...
begin
  ...
  qrsoma.sql.add('select sum(entrada) total_entrada, sum(saida) total_saida, ' + // total_entrada e total_saida
    '(select sum(VALOR) valor    from c000044 where atb like :atb and movimento = 03 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // sum
    '(select sum(VALOR) valor_1  from c000044 where atb like :atb and movimento = 04 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // sum_1
    '(select sum(VALOR) valor_2  from c000044 where atb like :atb and movimento = 05 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // sum_2
    '(select sum(VALOR) valor_3  from c000044 where atb like :atb and movimento = 06 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // sum_3
    '(select sum(VALOR) valor_4  from c000044 where atb like :atb and movimento = 07 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // sum_4
    '(select sum(VALOR) valor_5  from c000044 where atb like :atb and movimento = 08 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // sum_5
    '(select sum(VALOR) valor_6  from c000044 where atb like :atb and movimento = 09 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // 6 rec dinheiro
    '(select sum(VALOR) valor_7  from c000044 where atb like :atb and movimento = 10 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // 7 rec che av
    '(select sum(VALOR) valor_8  from c000044 where atb like :atb and movimento = 11 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // 8 rec che ap
    '(select sum(VALOR) valor_9  from c000044 where atb like :atb and movimento = 12 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // 9 rec cartao
    '(select sum(VALOR) valor_10 from c000044 where atb like :atb and movimento = 13 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // 10 rec juros
    '(select sum(VALOR) valor_11 from c000044 where atb like :atb and movimento = 14 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // 11 rec desconto
    '(select sum(VALOR) valor_12 from c000044 where atb like :atb and movimento = 15 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // 12 rec boleto
    '(select sum(VALOR) valor_13 from c000044 where atb like :atb and movimento = 25 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // 13 pagar - caixa
    '(select sum(VALOR) valor_14 from c000044 where atb like :atb and movimento = 26 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // 14 pagar - banco
    '(select sum(VALOR) valor_15 from c000044 where atb like :atb and movimento = 27 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // 15 pagar - terceiro
    '(select sum(VALOR) valor_16 from c000044 where atb like :atb and movimento = 2  and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // 16 LANCTO SAIDA
    '(select sum(VALOR) valor_17 from c000044 where atb like :atb and movimento = 17 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // 17 OUTRAS SAIDAS
    '(select sum(VALOR) valor_18 from c000044 where atb like :atb and movimento = 18 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // sum_18  - dinheiro
    '(select sum(VALOR) valor_19 from c000044 where atb like :atb and movimento = 19 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // sum_19  - cree
    '(select sum(VALOR) valor_20 from c000044 where atb like :atb and movimento = 20 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // column_20  - cv
    '(select sum(VALOR) valor_21 from c000044 where atb like :atb and movimento = 21 and data >= :datai and data <= :dataf ' + caixa + conta + '), ' + // column_21  - cp
  ...
  begin
    ...
    qrcaixa.close;
    qrcaixa.SQL.Clear;
    qrcaixa.sql.add('select * from c000044 where atb like :atb and data >= :datai and data <= :dataf ' + caixa + conta + ' order by codigo');
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('c:\SOS\server\rel\f000071_1.fr3');
    fxcAIXA.ShowReport;
  end;
  ...
  begin
    ...
    qrcaixa.close;
    qrcaixa.SQL.Clear;
    qrcaixa.sql.add('select * from c000044 where atb like :atb and data >= :datai and data <= :dataf ' + caixa + conta + ' and movimento in (2,17,22,26,27) order by codigo');
    qrcaixa.Params.ParamByName('datai').asdatetime := dateedit1.date;
    qrcaixa.Params.ParamByName('dataf').asdatetime := dateedit2.date;
    qrcaixa.ParamByName('atb').Value := ME_FiltraATB('TB_MOVIMENTO_CAIXA');
    qrcaixa.open;
    ...
    fxcAIXA.LoadFromFile('c:\SOS\server\rel\f000072.fr3');
    fxcAIXA.ShowReport;
  end;
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('c:\SOS\server\rel\f000073.fr3');
    fxcAIXA.ShowReport;
  end;
  ...
  frmPrincipal.logUC('Abriu Relatorio Caixa - ' + frmPrincipal.RemoveAcentos(combo_relatorio.Text), 0);
...
begin
  ...
  if combo_relatorio.Text = 'FOLHA DE CAIXA' then
  begin
    fxcAIXA.LoadFromFile('\SOS\server\rel\f000071.fr3');
