object frmprevenda_contasreceber: Tfrmprevenda_contasreceber
  Left = 331
  Top = 249
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'PR'#201'-VENDA - Lan'#231'amento de Contas a Receber'
  ClientHeight = 387
  ClientWidth = 456
  Color = clBtnFace
  ...
  object dsvenda_contasreceber: TDataSource
    DataSet = frmPrevenda.qrvenda_contasreceber
    Left = 392
    Top = 128
  end
end
