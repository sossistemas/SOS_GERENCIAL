object frmImpressoras: TfrmImpressoras
  ...
  object qrImpressora: TZQuery
    Connection = frmmodulo.Conexao
    BeforePost = qrImpressoraBeforePost
    AfterPost = qrImpressoraAfterPost
    SQL.Strings = (
      'select * from tipo_impressora')
    Params = <>
    Left = 204
    Top = 193
    object qrImpressoraID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object qrImpressoraDESCRICAO: TWideStringField
      FieldName = 'DESCRICAO'
      Size = 30
    end
  end
  object dsImpressora: TDataSource
    DataSet = qrImpressora
  ...
  object qrExclui: TZQuery
    ...
    SQL.Strings = (
        ...
        'select count(*) qtd  from c000017 gr where gr.id_tp_impressora =' +
        ' 1')
    Params = <>
    Left = 257
    Top = 129
