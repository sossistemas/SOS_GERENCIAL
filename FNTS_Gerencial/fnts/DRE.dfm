object frmDRE: TfrmDRE
  ...
  object qrDRE: TZQuery
    Connection = frmmodulo.econexao2
    OnCalcFields = qrDRECalcFields
    SQL.Strings = (
      'Select'
      ''
      '  Classificacao,'
      ...
      '      c000042, c000035'
      '    where'
      '      c000042.codconta = c000035.codigo'
      '    group by'
      '      Classificacao,'
      '      tipo,'
      '      Nome_Conta'
      ...
      '      c000035.tipo as tipo,'
      '      c000035.conta as Nome_Conta,'
      '      sum(c000044.Valor) as Total'
      '    from'
      '      c000044, c000035'
      '    where'
      '      c000044.codconta = c000035.codigo'
      '    group by'
      '      Classificacao,'
      '      tipo,'
      '      Nome_Conta'
    ...
    Left = 480
    Top = 192
    object qrDRECLASSIFICACAO: TWideStringField
      FieldName = 'CLASSIFICACAO'
      ReadOnly = True
      Size = 10
    end
    object qrDRETIPO: TIntegerField
      FieldName = 'TIPO'
      ReadOnly = True
    end
    object qrDRENOME_CONTA: TWideStringField
      FieldName = 'NOME_CONTA'
      ReadOnly = True
      Size = 40
    end
    object qrDRETOTAL: TFloatField
      FieldName = 'TOTAL'
      ReadOnly = True
    end
    object qrDREnome_tipo: TStringField
  ...
  object relDRE: TfrxReport
    ...
    ReportOptions.LastChange = 40099.718890740700000000
    ...
    object Page1: TfrxReportPage
      ...
      object GroupFooter1: TfrxGroupFooter
        ...
        object Memo12: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            'TOTAL DO GRUPO [fsDRE."nome_tipo"]')
          ParentFont = False
        end
      end
    end
