...
uses
  ...
  Menus, Buttons, TFlatPanelUnit, AdvGlowButton, AdvShapeButton, AdvMetroButton, AdvSmoothPanel, AdvSmoothExpanderPanel, JvExMask,
...
uses modulo, principal, prevenda_contasreceber, troco,
  venda_obs, cheque, prevenda, extenso1,
  cheque_avulso;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            texto := PWideChar('Este cliente possue um limite disponível de:' + #13 + ' ---> R$ ' + formatfloat('###,###,##0.00', limite_disponivel) + '  <--- ' + #13 + 'É necessário autorização para prosseguir! ' + #13 + 'Deseja continuar?');
