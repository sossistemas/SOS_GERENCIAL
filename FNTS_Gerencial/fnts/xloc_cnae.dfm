object frmxloc_cnae: Tfrmxloc_cnae
  Left = 514
  Top = 113
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'CNAE | Localizar'
  ClientHeight = 352
  ClientWidth = 643
  Color = clBtnFace
  ...
  object GRID: TwwDBGrid
    ...
    Selected.Strings = (
      ...
      'DESCRICAO'#9'70'#9'DESCRI'#199#195'O'#9'F'#9)
  ...
  object query: TZQuery
    ...
    object queryCNAE: TWideStringField
      FieldName = 'CNAE'
      Size = 10
    end
    ...
    object queryABREVIADO: TWideStringField
      FieldName = 'ABREVIADO'
      Size = 50
    end
  end
