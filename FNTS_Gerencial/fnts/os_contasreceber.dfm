object frmos_contasreceber: Tfrmos_contasreceber
  Left = 418
  Top = 233
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'O.S. | Gerar Contas a Receber'
  ClientHeight = 347
  ClientWidth = 445
  Color = clBtnFace
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Selected.Strings = (
      ...
      'TIPO'#9'16'#9'Tipo'#9#9
      'DOCUMENTO'#9'18'#9'Documento'#9#9
  ...
  object dsvenda_contasreceber: TDataSource
    DataSet = frmos.qrOS_contasreceber
    Left = 392
    Top = 128
  end
end
