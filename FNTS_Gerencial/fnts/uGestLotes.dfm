object frmLotes: TfrmLotes
  ...
  object PopupEVtela: TPopupMenu
    AutoPopup = False
    Left = 472
    Top = 24
    object L1: TMenuItem
      Caption = 'Limpar C'#243'd Produto'
      ShortCut = 115
      OnClick = L1Click
    end
  end
  object qryLote: TZQuery
    ...
    SQL.Strings = (
      ...
      '  l.status'
      'from lote l'
      'left join lote_item li on li.id_lote = l.id'
      'where 1 = 1'
    ...
    object qryLoteID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object qryLoteDESCRED: TWideStringField
      FieldName = 'DESCRED'
      Size = 40
    end
    object qryLoteDATA_INICIO: TDateField
      FieldName = 'DATA_INICIO'
    end
    object qryLoteHORA_INICIO: TTimeField
      FieldName = 'HORA_INICIO'
    end
    object qryLoteDATA_FIM: TDateField
      FieldName = 'DATA_FIM'
    end
    object qryLoteHORA_FIM: TTimeField
      FieldName = 'HORA_FIM'
    end
    object qryLoteSTATUS: TWideStringField
      FieldName = 'STATUS'
      Size = 2
    end
  end
  ...
  object qryItemLote: TZQuery
    Connection = frmmodulo.Conexao
    SQL.Strings = (
      'select li.*, pr.produto, pr.unidade'
      'from lote_item LI'
      'join c000025 PR on pr.codigo = li.codproduto'
      'where 1 = 1'
      'and (:codproduto is null or (li.codproduto =:codproduto))'
      'and (:idLote is null or (li.id_lote =:idlote))'
      'and (:codfor is null or (li.codfornecedor =:codfor))'
      
        'and ((:dtVini is null and :dtVfim is null) or (li.validadeprodut' +
        'o between :dtVini and :dtVfim))'
      'order by li.id_lote')
    Params = <
      item
        DataType = ftUnknown
    ...
    object qryItemLoteID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object qryItemLoteCODPRODUTO: TWideStringField
      FieldName = 'CODPRODUTO'
      Size = 10
    end
    object qryItemLoteSALDO: TFloatField
      FieldName = 'SALDO'
      DisplayFormat = '#,###,###0.000'
    end
    object qryItemLoteFABRICACAOPROD: TDateField
      FieldName = 'FABRICACAOPROD'
    end
    object qryItemLotePRECUSTO: TFloatField
      FieldName = 'PRECUSTO'
    end
    object qryItemLoteCODFORNECEDOR: TWideStringField
      FieldName = 'CODFORNECEDOR'
      Size = 10
    end
    object qryItemLoteVALIDADEPRODUTO: TDateField
      FieldName = 'VALIDADEPRODUTO'
    end
    object qryItemLoteTOTAL_CUSTO: TFloatField
      FieldName = 'TOTAL_CUSTO'
      ReadOnly = True
    end
    object qryItemLoteID_LOTE: TIntegerField
      FieldName = 'ID_LOTE'
    end
    object qryItemLotePRODUTO: TWideStringField
      FieldName = 'PRODUTO'
      Size = 100
    end
    object qryItemLoteUNIDADE: TWideStringField
      FieldName = 'UNIDADE'
      Size = 3
    end
  end
  object dsItemLote: TDataSource
    DataSet = qryItemLote
    Left = 48
    Top = 520
  end
