...
begin
  ...
  ForceDirectories('C:\SOS\Server\img\Produtos');
  frmproduto.image2.picture.loadfromfile('C:\SOS\Server\img\Produtos\ft' + frmmodulo.qrproduto.fieldbyname('codigo').asstring + '.BMP');
  FRMPRODUTO.QRPRODUTO.FIELDBYNAME('FOTO').ASSTRING := 'C:\SOS\Server\img\Produtos\ft' + frmmodulo.qrproduto.fieldbyname('codigo').asstring + '.BMP';
  close;
end;
