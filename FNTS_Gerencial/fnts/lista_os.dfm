object frmlista_os: Tfrmlista_os
  ...
  object qros: TZQuery
    ...
    SQL.Strings = (
        ...
        'select os.*, cli.nome cliente, fun.nome detectado_tecnico from c' +
        '000051 os'
      'left join c000007 cli on cli.codigo = os.codcliente'
      'left join c000008 fun on fun.codigo = os.detectado_codtecnico')
    Params = <>
    Left = 568
    Top = 376
    ...
    object qrosCLIENTE: TWideStringField
      FieldName = 'CLIENTE'
      Size = 80
    end
    object qrosDETECTADO_TECNICO: TWideStringField
  ...
  object fxos: TfrxReport
    ...
    ReportOptions.LastChange = 41621.655676157400000000
