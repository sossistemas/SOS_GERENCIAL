object frmCsosn: TfrmCsosn
  ...
  object cxDBTextEdit1: TcxDBTextEdit
    ...
    DataBinding.DataSource = dsCsosn
    TabOrder = 2
    Width = 609
  end
  ...
  object cxDBCheckBox1: TcxDBCheckBox
    ...
    Top = 135
    Caption = 
      'Aplica Regra de ICMS EFETIVO na Emiss'#227'o da NF-e e NFC-e para CFO' +
      'P 5405'
  ...
  object dsCsosn: TDataSource
    DataSet = qrCsosn
    OnStateChange = dsCsosnStateChange
    Left = 464
    Top = 56
  end
  object qrCsosn: TZQuery
    ...
    object qrCsosnST: TWideStringField
      FieldName = 'ST'
      Size = 1
    end
  end
