...
begin
  ...
  begin
    ...
    begin
      application.messagebox('Produdo Sem Preço de Custo!, Verifique', 'Atenção', mb_ok + MB_ICONEXCLAMATION);
    end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin // opção para a ouro preto  nota de consignação
            ed_icms_base.value := ed_total.value;
            ed_icms_valor.value := 0;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        application.messagebox('CSOSN não cadastrado!', 'Aviso', mb_ok + mb_iconwarning);
        ed_csosn.setfocus;
      end;
    end
    else
